        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          ...
          <div className="flex items-start justify-end lg:order-first">
            <img
              ...
              width={2432}
              height={1442}
              className="w-[48rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] dark:hidden dark:ring-white/10"
            />
            <img
              alt="Product screenshot"
              ...
              width={2432}
              height={1442}
              className="hidden w-[48rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] dark:block dark:ring-white/10"
            />
          </div>
        </div>
      </div>
