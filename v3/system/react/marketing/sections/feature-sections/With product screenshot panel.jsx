            ...
            <div className="relative isolate overflow-hidden bg-indigo-500 px-6 pt-8 sm:mx-auto sm:max-w-2xl sm:rounded-3xl sm:pl-16 sm:pr-0 sm:pt-16 lg:mx-0 lg:max-w-none">
              ...
              <div className="mx-auto max-w-2xl sm:mx-0 sm:max-w-none">
                ...
                <img
                  ...
                  width={2432}
                  height={1442}
                  className="-mb-12 hidden w-[57rem] max-w-none rounded-tl-xl bg-gray-950 ring-1 ring-white/10 dark:block"
                />
              </div>
              <div
                aria-hidden="true"
                className="pointer-events-none absolute inset-0 ring-1 ring-inset ring-black/10 sm:rounded-3xl dark:ring-white/10"
              />
            </div>
          </div>
        </div>
