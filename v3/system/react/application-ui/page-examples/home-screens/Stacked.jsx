        ...
        <div className="relative isolate overflow-hidden pt-16">
          ...
          <header className="pb-4 pt-6 sm:pb-6">
            <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
              ...
              <div className="order-last flex w-full gap-x-8 text-sm/6 font-semibold sm:order-none sm:w-auto sm:border-l sm:border-gray-200 sm:pl-6 sm:text-sm/7 dark:sm:border-white/10">
          ...
          <div
            aria-hidden="true"
            className="absolute left-0 top-full -z-10 mt-96 origin-top-left translate-y-40 -rotate-90 transform-gpu opacity-20 blur-3xl sm:left-1/2 sm:-ml-96 sm:-mt-10 sm:translate-y-0 sm:rotate-0 sm:opacity-50 dark:opacity-10 dark:sm:opacity-30"
          >
            <div
              style={{
                clipPath:
                        ...
                        <Fragment key={day.dateTime}>
                          <tr className="text-sm/6 text-gray-900 dark:text-white">
                            <th scope="colgroup" colSpan={3} className="relative isolate py-2 font-semibold">
                              ...
                              <div className="absolute inset-y-0 right-full -z-10 w-screen border-b border-gray-200 bg-gray-50 dark:border-white/10 dark:bg-white/[0.025]" />
                              <div className="absolute inset-y-0 left-0 -z-10 w-screen border-b border-gray-200 bg-gray-50 dark:border-white/10 dark:bg-white/[0.025]" />
                            </th>
                          </tr>
            ...
            <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
              ...
              <ul role="list" className="mt-6 grid grid-cols-1 gap-x-6 gap-y-8 lg:grid-cols-3 xl:gap-x-8">
                {clients.map((client) => (
                  <li
                    key={client.id}
                    className="overflow-hidden rounded-xl outline outline-1 outline-gray-200 dark:-outline-offset-1 dark:outline-white/10"
                  >
