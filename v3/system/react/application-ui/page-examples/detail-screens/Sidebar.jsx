          ...
          <main>
            <header>
              ...
              <div className="flex flex-col items-start justify-between gap-x-8 gap-y-4 bg-gray-50 px-4 py-4 sm:flex-row sm:items-center sm:px-6 lg:px-8 dark:bg-gray-700/10">
                ...
                <div className="order-first flex-none rounded-full bg-indigo-50 px-2 py-1 text-xs font-medium text-indigo-500 ring-1 ring-inset ring-indigo-200 sm:order-none dark:bg-indigo-400/10 dark:text-indigo-400 dark:ring-indigo-400/30">
                  Production
                </div>
              </div>
                    ...
                    <tr key={item.commit}>
                      ...
                      <td className="hidden py-4 pl-0 pr-4 sm:table-cell sm:pr-8">
                        <div className="flex gap-x-3">
                          ...
                          <span className="inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-300 dark:bg-gray-400/10 dark:text-gray-400 dark:ring-gray-400/20">
                            {item.branch}
                          </span>
                        </div>
                      </td>
                      ...
                      <td className="hidden py-4 pl-0 pr-8 text-sm/6 text-gray-500 md:table-cell lg:pr-20 dark:text-gray-400">
                        {item.duration}
                      </td>
                      <td className="hidden py-4 pl-0 pr-4 text-right text-sm/6 text-gray-500 sm:table-cell sm:pr-6 lg:pr-8 dark:text-gray-400">
