            ...
            <div className="mx-auto flex max-w-2xl items-center justify-between gap-x-8 lg:mx-0 lg:max-w-none">
              <div className="flex items-center gap-x-6">
                <img
                  ...
                  className="size-16 flex-none rounded-full bg-gray-100 outline outline-1 -outline-offset-1 outline-black/5 dark:bg-gray-800 dark:outline-white/10"
                />
                <h1>
              ...
              <div className="rounded-lg bg-gray-50 shadow-sm outline outline-1 outline-gray-900/5 dark:bg-gray-800/50 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10">
                <dl className="flex flex-wrap">
                  ...
                  <div className="flex-none self-end px-6 pt-4">
                    ...
                    <dd className="rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-600 ring-1 ring-inset ring-green-600/20 dark:bg-green-500/10 dark:text-green-500 dark:ring-green-500/30">
                      Paid
                    </dd>
                  </div>
                    ...
                    {activityItem.type === 'commented' ? (
                      <>
                        <img
                          ...
                          className="relative mt-3 size-6 flex-none rounded-full bg-gray-100 outline outline-1 -outline-offset-1 outline-black/5 dark:bg-gray-800 dark:outline-white/10"
                        />
                        <div className="flex-auto rounded-md p-3 ring-1 ring-inset ring-gray-200 dark:ring-white/10">
