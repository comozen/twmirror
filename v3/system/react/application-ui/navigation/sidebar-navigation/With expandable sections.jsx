                  ...
                  {!item.children ? (
                    <a
                      ...
                      className={classNames(
                        ...
                        'block rounded-md py-2 pl-10 pr-2 text-sm/6 font-semibold text-gray-700 dark:text-gray-400',
                      )}
                    >
                      {item.name}
                    </a>
                          ...
                          <li key={subItem.name}>
                            <DisclosureButton
                              ...
                              className={classNames(
                                ...
                                'block rounded-md py-2 pl-9 pr-2 text-sm/6 text-gray-700 dark:text-gray-400',
                              )}
                            >
                              {subItem.name}
                            </DisclosureButton>
