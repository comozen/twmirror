                ...
                <li key={item.name}>
                  ...
                  >
                    ...
                    {item.count ? (
                      <span
                        aria-hidden="true"
                        className="ml-auto w-9 min-w-max whitespace-nowrap rounded-full bg-indigo-600 px-2.5 py-0.5 text-center text-xs/5 font-medium text-white outline outline-1 -outline-offset-1 outline-indigo-500 dark:bg-indigo-800 dark:outline-indigo-600/75"
                      >
                        {item.count}
                      </span>
                    ) : null}
