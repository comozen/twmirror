    ...
    <>
      ...
      */}
      <div className="min-h-full">
        ...
        <header className="relative bg-white shadow dark:bg-gray-800 dark:shadow-none dark:after:pointer-events-none dark:after:absolute dark:after:inset-x-0 dark:after:inset-y-0 dark:after:border-y dark:after:border-white/10">
