      ...
      <div className="min-h-full">
        <header className="bg-indigo-600 pb-24 dark:bg-indigo-800">
            ...
            <div className="relative flex items-center justify-center py-5 lg:justify-between">
              ...
              <div className="hidden lg:ml-4 lg:flex lg:items-center lg:pr-0.5">
                ...
                <Menu as="div" className="relative ml-4 shrink-0">
                  ...
                  <MenuItems
                    transition
                    className="absolute right-0 z-10 -mr-2 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg outline outline-1 outline-black/5 data-[closed]:data-[leave]:scale-95 data-[closed]:data-[leave]:transform data-[closed]:data-[leave]:opacity-0 data-[leave]:transition data-[leave]:duration-75 data-[leave]:ease-in dark:bg-gray-800 dark:-outline-offset-1 dark:outline-white/10"
                  >
              ...
              <div className="min-w-0 flex-1 px-12 lg:hidden">
                <div className="mx-auto grid w-full max-w-xs grid-cols-1">
                  <input
                    ...
                    placeholder="Search"
                    aria-label="Search"
                    className="col-start-1 row-start-1 block w-full rounded-md bg-indigo-500/75 py-1.5 pl-10 pr-3 text-base text-white outline outline-1 -outline-offset-1 outline-white/10 placeholder:text-white/75 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-white sm:text-sm/6 dark:bg-indigo-700/50 dark:outline-indigo-400/25 dark:placeholder:text-white/50"
                  />
                  <MagnifyingGlassIcon
                    aria-hidden="true"
          ...
          <Dialog open={open} onClose={setOpen} className="lg:hidden">
            ...
            >
              <div className="divide-y divide-gray-200 rounded-lg bg-white shadow-lg outline outline-1 outline-black/5 dark:divide-white/10 dark:bg-gray-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10">
                ...
                <div className="pb-2 pt-4">
                  <div className="flex items-center px-5">
                    ...
                    <button
                      type="button"
                      className="relative ml-auto shrink-0 rounded-full p-1 text-gray-400 hover:text-gray-500 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500 dark:text-gray-400 dark:hover:text-white dark:focus:outline-white"
                    >
                      <span className="absolute -inset-1.5" />
                      <span className="sr-only">View notifications</span>
                      <BellIcon aria-hidden="true" className="size-6" />
            ...
            <div className="grid grid-cols-1 items-start gap-4 lg:grid-cols-3 lg:gap-8">
              ...
              <div className="grid grid-cols-1 gap-4 lg:col-span-2">
                <section aria-labelledby="section-1-title">
                  ...
                  <div className="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800 dark:shadow-none dark:outline dark:outline-1 dark:-outline-offset-1 dark:outline-white/10">
              ...
              <div className="grid grid-cols-1 gap-4">
                <section aria-labelledby="section-2-title">
                  ...
                  <div className="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800 dark:shadow-none dark:ring-1 dark:ring-inset dark:ring-white/10">
                    <div className="p-6">{/* Your content */}</div>
                  </div>
                </section>
              </div>
