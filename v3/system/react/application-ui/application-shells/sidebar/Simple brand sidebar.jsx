    ...
    <>
      ...
      */}
      <div>
                ...
                <li className="-mx-6 mt-auto">
                  ...
                  >
                    <img
                      ...
                      className="size-8 rounded-full bg-indigo-700 outline outline-1 -outline-offset-1 outline-white/10 dark:bg-indigo-800"
                    />
        ...
        <div className="sticky top-0 z-40 flex items-center gap-x-6 bg-indigo-600 px-4 py-4 shadow-sm sm:px-6 lg:hidden dark:bg-indigo-800 dark:after:pointer-events-none dark:after:absolute dark:after:inset-x-0 dark:after:bottom-0 dark:after:h-px dark:after:bg-white/10">
          <button
            type="button"
