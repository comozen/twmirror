      ...
      <div className="flex min-h-full flex-col">
        ...
        <div className="mx-auto w-full max-w-7xl grow lg:flex xl:px-2">
          ...
          <div className="flex-1 xl:flex">
            <div className="border-b border-gray-200 px-4 py-6 sm:px-6 lg:pl-8 xl:w-64 xl:shrink-0 xl:border-b-0 xl:border-r xl:pl-6 dark:border-white/10">
              {/* Left column area */}
            </div>
          ...
          <div className="shrink-0 border-t border-gray-200 px-4 py-6 sm:px-6 lg:w-96 lg:border-l lg:border-t-0 lg:pr-8 xl:pr-6 dark:border-white/10">
            {/* Right column area */}
          </div>
        </div>
      </div>
