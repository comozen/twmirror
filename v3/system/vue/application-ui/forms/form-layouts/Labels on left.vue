  ...
  <form>
    <div class="space-y-12 sm:space-y-16">
      <div>
        ...
        <p class="mt-1 max-w-2xl text-sm/6 text-gray-600 dark:text-gray-400">This information will be displayed publicly so be careful what you share.</p>
        ...
        <div class="mt-10 space-y-8 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:border-t-gray-900/10 sm:pb-0 dark:border-white/10 dark:sm:divide-white/10 dark:sm:border-t-white/10">
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
            <label for="username" class="block text-sm/6 font-medium text-gray-900 sm:pt-1.5 dark:text-white">Username</label>
            <div class="mt-2 sm:col-span-2 sm:mt-0">
              <div class="flex items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 outline-gray-300 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 sm:max-w-md dark:bg-white/5 dark:outline-white/10 dark:focus-within:outline-indigo-500">
                <div class="shrink-0 select-none text-base text-gray-500 sm:text-sm/6 dark:text-gray-400">workcation.com/</div>
                <input type="text" name="username" id="username" class="block min-w-0 grow bg-white py-1.5 pl-1 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6 dark:bg-transparent dark:text-white dark:placeholder:text-gray-500" placeholder="janesmith" />
              </div>
            </div>
          </div>

          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
            <label for="about" class="block text-sm/6 font-medium text-gray-900 sm:pt-1.5 dark:text-white">About</label>
            <div class="mt-2 sm:col-span-2 sm:mt-0">
              <textarea name="about" id="about" rows="3" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:max-w-2xl sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-white/10 dark:placeholder:text-gray-500 dark:focus:outline-indigo-500" />
          ...
          <div class="sm:grid sm:grid-cols-3 sm:items-center sm:gap-4 sm:py-6">
            ...
            <div class="mt-2 sm:col-span-2 sm:mt-0">
              <div class="flex items-center gap-x-3">
                ...
                <button type="button" class="rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 dark:bg-white/10 dark:text-white dark:shadow-none dark:ring-white/5 dark:hover:bg-white/20">Change</button>
              </div>
            </div>
          </div>

          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
            <label for="cover-photo" class="block text-sm/6 font-medium text-gray-900 sm:pt-1.5 dark:text-white">Cover photo</label>
            <div class="mt-2 sm:col-span-2 sm:mt-0">
      ...
      <div>
        ...
        <p class="mt-1 max-w-2xl text-sm/6 text-gray-600 dark:text-gray-400">Use a permanent address where you can receive mail.</p>

        <div class="mt-10 space-y-8 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:border-t-gray-900/10 sm:pb-0 dark:border-white/10 dark:sm:divide-white/10 dark:sm:border-t-white/10">
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
            <label for="first-name" class="block text-sm/6 font-medium text-gray-900 sm:pt-1.5 dark:text-white">First name</label>
            <div class="mt-2 sm:col-span-2 sm:mt-0">
          ...
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
            <label for="last-name" class="block text-sm/6 font-medium text-gray-900 sm:pt-1.5 dark:text-white">Last name</label>
            <div class="mt-2 sm:col-span-2 sm:mt-0">
          ...
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
            <label for="email" class="block text-sm/6 font-medium text-gray-900 sm:pt-1.5 dark:text-white">Email address</label>
            <div class="mt-2 sm:col-span-2 sm:mt-0">
          ...
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
            <label for="country" class="block text-sm/6 font-medium text-gray-900 sm:pt-1.5 dark:text-white">Country</label>
            <div class="mt-2 sm:col-span-2 sm:mt-0">
          ...
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
            <label for="street-address" class="block text-sm/6 font-medium text-gray-900 sm:pt-1.5 dark:text-white">Street address</label>
            <div class="mt-2 sm:col-span-2 sm:mt-0">
          ...
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
            <label for="city" class="block text-sm/6 font-medium text-gray-900 sm:pt-1.5 dark:text-white">City</label>
            <div class="mt-2 sm:col-span-2 sm:mt-0">
          ...
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
            <label for="region" class="block text-sm/6 font-medium text-gray-900 sm:pt-1.5 dark:text-white">State / Province</label>
            <div class="mt-2 sm:col-span-2 sm:mt-0">
          ...
          <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
            <label for="postal-code" class="block text-sm/6 font-medium text-gray-900 sm:pt-1.5 dark:text-white">ZIP / Postal code</label>
            <div class="mt-2 sm:col-span-2 sm:mt-0">
      ...
      <div>
        ...
        <p class="mt-1 max-w-2xl text-sm/6 text-gray-600 dark:text-gray-400">We'll always let you know about important changes, but you pick what else you want to hear about.</p>

        <div class="mt-10 space-y-10 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:border-t-gray-900/10 sm:pb-0 dark:border-white/10 dark:sm:divide-white/10 dark:sm:border-t-white/10">
          <fieldset>
            <legend class="sr-only">By email</legend>
            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:py-6">
              <div class="text-sm/6 font-semibold text-gray-900 dark:text-white" aria-hidden="true">By email</div>
          ...
          <fieldset>
            ...
            <div class="sm:grid sm:grid-cols-3 sm:items-baseline sm:gap-4 sm:py-6">
              <div class="text-sm/6 font-semibold text-gray-900 dark:text-white" aria-hidden="true">Push notifications</div>
              <div class="mt-1 sm:col-span-2 sm:mt-0">
                <div class="max-w-lg">
                  <p class="text-sm/6 text-gray-600 dark:text-gray-400">These are delivered via SMS to your mobile phone.</p>
