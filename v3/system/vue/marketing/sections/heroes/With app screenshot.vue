    ...
    <div class="relative isolate pt-14">
      ...
      <div class="py-24 sm:py-32 lg:pb-40">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <img src="/plus-assets/img/component-images/dark-project-app-screenshot.png" alt="App screenshot" width="2432" height="1442" class="mt-16 hidden rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10 sm:mt-24 dark:block" />
        </div>
      </div>
