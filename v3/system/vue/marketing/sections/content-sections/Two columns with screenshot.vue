  ...
  <div class="bg-white py-24 sm:py-32 dark:bg-gray-900">
    ...
    <div class="relative overflow-hidden pt-16 lg:pt-20">
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <img class="mb-[-12%] hidden rounded-xl shadow-2xl ring-1 ring-gray-900/10 dark:block dark:shadow-xl dark:ring-white/10" src="/plus-assets/img/component-images/dark-project-app-screenshot.png" alt="" />
