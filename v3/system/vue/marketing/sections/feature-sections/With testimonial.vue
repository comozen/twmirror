      ...
      <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start">
        <div class="lg:pr-4 lg:pt-4">
          <div class="lg:max-w-lg">
            ...
            <div class="mt-8">
              <a href="#" class="inline-flex rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:bg-indigo-500 dark:hover:bg-indigo-400 dark:focus-visible:outline-indigo-500">Get started</a>
            </div>
            <figure class="mt-16 border-l border-gray-200 pl-8 text-gray-700 dark:border-gray-700 dark:text-gray-300">
              ...
              <figcaption class="mt-6 flex gap-x-4 text-sm/6">
                ...
                <div><span class="font-semibold text-gray-900 dark:text-white">Maria Hill</span> – <span class="text-gray-600 dark:text-gray-400">Marketing Manager</span></div>
              </figcaption>
            </figure>
          </div>
        </div>
        <img src="/plus-assets/img/component-images/dark-project-app-screenshot.png" alt="Product screenshot" class="w-[48rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] md:-ml-4 lg:ml-0 dark:ring-white/10" width="2432" height="1442" />
      </div>
    </div>
  </div>
</template>
