    ...
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      <div class="flex lg:flex-1">
        <a href="#" class="-m-1.5 p-1.5">
          ...
          <img class="h-8 w-auto dark:hidden" src="/plus-assets/img/logos/mark.svg?color=white" alt="" />
          <img class="hidden h-8 w-auto dark:block" src="/plus-assets/img/logos/mark.svg?color=white" alt="" />
        </a>
      </div>
