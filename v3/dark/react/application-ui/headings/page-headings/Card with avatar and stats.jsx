...
export default function Example() {
  return (
    <div className="overflow-hidden rounded-lg bg-gray-900 outline outline-1 -outline-offset-1 outline-white/10">
      ...
      <div className="bg-gray-800/75 p-6">
        <div className="sm:flex sm:items-center sm:justify-between">
          <div className="sm:flex sm:space-x-5">
            <div className="shrink-0">
              <img
                alt=""
                src={user.imageUrl}
                className="mx-auto size-20 rounded-full outline outline-1 -outline-offset-1 outline-white/10"
              />
            </div>
          ...
          <div className="mt-5 flex justify-center sm:mt-0">
            <a
              href="#"
              className="flex items-center justify-center rounded-md bg-white/10 px-3 py-2 text-sm font-semibold text-white ring-1 ring-inset ring-white/5 hover:bg-white/20"
            >
              View profile
            </a>
          </div>
