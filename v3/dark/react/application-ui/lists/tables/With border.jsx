            ...
            {plans.map((plan, planIdx) => (
              <tr key={plan.id}>
                ...
                >
                  ...
                  {planIdx !== 0 ? <div className="absolute -top-px left-6 right-0 h-px bg-white/10" /> : null}
                </td>
                <td
                  className={classNames(
                ...
                >
                  <button
                    ...
                    className="inline-flex items-center rounded-md bg-white/10 px-2.5 py-1.5 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-white/10 hover:bg-white/15 disabled:cursor-not-allowed disabled:opacity-30 disabled:hover:bg-white/10"
                  >
                    Select<span className="sr-only">, {plan.name}</span>
                  </button>
                  {planIdx !== 0 ? <div className="absolute -top-px left-0 right-6 h-px bg-white/10" /> : null}
                </td>
              </tr>
            ))}
          </tbody>
