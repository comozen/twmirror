                      ...
                      <div className="flex items-center">
                        <div className="size-11 shrink-0">
                          <img
                            alt=""
                            src={person.image}
                            className="size-11 rounded-full outline outline-1 outline-white/10"
                          />
                        </div>
                        <div className="ml-4">
                          <div className="font-medium text-white">{person.name}</div>
                          <div className="mt-1 text-gray-400">{person.email}</div>
                        </div>
                      </div>
                    </td>
                    <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-400">
                      <div className="text-white">{person.title}</div>
                      <div className="mt-1 text-gray-400">{person.department}</div>
                    </td>
                    <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-400">
                      <span className="inline-flex items-center rounded-md bg-green-900/30 px-2 py-1 text-xs font-medium text-green-400 ring-1 ring-inset ring-green-500/50">
                        Active
                      </span>
                    </td>
                    <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-400">{person.role}</td>
