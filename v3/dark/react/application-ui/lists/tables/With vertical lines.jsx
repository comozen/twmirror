            ...
            <table className="min-w-full divide-y divide-white/15">
              <thead>
                <tr className="divide-x divide-white/10">
                  ...
                  <th scope="col" className="py-3.5 pl-4 pr-4 text-left text-sm font-semibold text-white sm:pr-0">
                    Role
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/10 bg-gray-900">
                {people.map((person) => (
                  <tr key={person.email} className="divide-x divide-white/10">
                    ...
                    <td className="whitespace-nowrap p-4 text-sm text-gray-300">{person.title}</td>
                    <td className="whitespace-nowrap p-4 text-sm text-gray-300">{person.email}</td>
                    <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-300 sm:pr-0">{person.role}</td>
                  </tr>
                ))}
              </tbody>
            </table>
