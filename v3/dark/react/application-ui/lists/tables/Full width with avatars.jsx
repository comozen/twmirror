  ...
  return (
    <div className="bg-gray-900 py-10">
      ...
      <table className="mt-6 w-full whitespace-nowrap text-left">
        ...
        <thead className="border-b border-white/15 text-sm/6 text-white">
          <tr>
            ...
            <tr key={item.commit}>
              ...
              <td className="hidden py-4 pl-0 pr-4 sm:table-cell sm:pr-8">
                <div className="flex gap-x-3">
                  ...
                  <div className="rounded-md bg-gray-700/40 px-2 py-1 text-xs font-medium text-gray-400 outline outline-1 -outline-offset-1 outline-white/10">
                    {item.branch}
                  </div>
                </div>
              </td>
