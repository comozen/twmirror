              ...
              <tbody className="divide-y divide-white/10 bg-gray-900">
                {transactions.map((transaction) => (
                  <tr key={transaction.id}>
                    <td className="whitespace-nowrap py-2 pl-4 pr-3 text-sm text-gray-400 sm:pl-0">{transaction.id}</td>
                    <td className="whitespace-nowrap px-2 py-2 text-sm font-medium text-white">
                      {transaction.company}
                    </td>
                    <td className="whitespace-nowrap px-2 py-2 text-sm text-white">{transaction.share}</td>
                    <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-400">{transaction.commission}</td>
                    <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-400">{transaction.price}</td>
                    <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-400">{transaction.quantity}</td>
                    <td className="whitespace-nowrap px-2 py-2 text-sm text-gray-400">{transaction.netAmount}</td>
