...
export default function Example() {
  return (
    <div className="divide-y divide-white/10 overflow-hidden rounded-lg bg-gray-900 outline outline-1 -outline-offset-1 outline-white/20 sm:grid sm:grid-cols-2 sm:divide-y-0">
      {actions.map((action, actionIdx) => (
        <div
          ...
          className={classNames(
            ...
            'group relative border-white/10 bg-gray-800/50 p-6 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-500 sm:even:border-l sm:even:[&:not(:last-child)]:border-b sm:odd:[&:not(nth-last-2)]:border-b',
          )}
        >
          <div>
          ...
          <span
            aria-hidden="true"
            className="pointer-events-none absolute right-6 top-6 text-gray-500 group-hover:text-gray-200"
          >
