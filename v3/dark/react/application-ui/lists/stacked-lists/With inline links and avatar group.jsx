              ...
              {discussion.commenters.map((commenter) => (
                <dd key={commenter.id}>
                  <img
                    ...
                    className="size-6 rounded-full bg-gray-800 outline outline-2 outline-gray-900"
                  />
                </dd>
              ))}
            </div>
            <div className="flex w-16 gap-x-2.5">
              <dt>
                ...
                {discussion.status === 'resolved' ? (
                  <CheckCircleIcon aria-hidden="true" className="size-6 text-gray-500" />
                ) : (
                  <ChatBubbleLeftIcon aria-hidden="true" className="size-6 text-gray-500" />
                )}
              </dt>
              <dd className="text-sm/6 text-white">{discussion.totalComments}</dd>
            </div>
          </dl>
        </li>
      ))}
