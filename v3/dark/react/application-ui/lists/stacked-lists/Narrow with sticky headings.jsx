    ...
    <nav aria-label="Directory" className="h-full overflow-y-auto">
      {Object.keys(directory).map((letter) => (
        <div key={letter} className="relative">
          <div className="sticky top-0 z-10 border-y border-b-white/10 border-t-white/5 bg-gray-900 px-3 py-1.5 text-sm/6 font-semibold text-white before:pointer-events-none before:absolute before:inset-0 before:bg-white/5">
