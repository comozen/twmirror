        ...
        >
          {query.length > 0 && (
            <ComboboxOption
              ...
              className="cursor-default select-none px-3 py-2 text-gray-300 data-[focus]:bg-indigo-500 data-[focus]:text-white data-[focus]:outline-none"
            >
              <div className="flex items-center">
                <span
                  className="inline-block size-2 shrink-0 rounded-full border border-gray-600 [[aria-active='true']_&]:border-white/75"
                  aria-hidden="true"
                />
              ...
              <div className="flex items-center">
                <span
                  className={classNames(
                    ...
                    person.online ? 'bg-green-500' : 'bg-white/20',
                  )}
                  aria-hidden="true"
                />
