      ...
      <div className="space-y-4">
        {plans.map((plan) => (
          <label
            ...
            className="group relative block rounded-lg border border-white/10 bg-gray-800/50 px-6 py-4 has-[:checked]:outline has-[:focus-visible]:outline has-[:checked]:outline-2 has-[:focus-visible]:outline-[3px] has-[:checked]:-outline-offset-2 has-[:focus-visible]:-outline-offset-1 has-[:checked]:outline-indigo-500 sm:flex sm:justify-between"
          >
            <input
