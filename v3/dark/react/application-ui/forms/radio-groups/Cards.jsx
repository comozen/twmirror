      ...
      <div className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-3 sm:gap-x-4">
        {mailingLists.map((mailingList) => (
          <label
            ...
            className="group relative flex rounded-lg border border-white/10 bg-gray-800/50 p-4 has-[:checked]:bg-indigo-500/10 has-[:disabled]:bg-gray-800 has-[:disabled]:opacity-25 has-[:checked]:outline has-[:focus-visible]:outline has-[:checked]:outline-2 has-[:focus-visible]:outline-[3px] has-[:checked]:-outline-offset-2 has-[:focus-visible]:-outline-offset-1 has-[:checked]:outline-indigo-500"
          >
            <input
