    ...
    <fieldset aria-label="Pricing plans" className="relative -space-y-px rounded-md bg-gray-800/50">
      {plans.map((plan) => (
        <label
          ...
          className="group flex flex-col border border-gray-700 p-4 first:rounded-tl-md first:rounded-tr-md last:rounded-bl-md last:rounded-br-md focus:outline-none has-[:checked]:relative has-[:checked]:border-indigo-800 has-[:checked]:bg-indigo-600/10 md:grid md:grid-cols-3 md:pl-4 md:pr-6"
        >
          ...
          <span className="ml-6 pl-1 text-sm md:ml-0 md:pl-0 md:text-center">
            <span className="font-medium text-white group-has-[:checked]:text-indigo-300">
