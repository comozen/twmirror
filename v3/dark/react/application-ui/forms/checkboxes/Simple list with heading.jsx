...
export default function Example() {
  return (
    <fieldset>
      ...
      <div className="mt-4 divide-y divide-white/10 border-b border-t border-white/10">
        {people.map((person, personIdx) => (
          <div key={personIdx} className="relative flex gap-3 py-4">
            <div className="min-w-0 flex-1 text-sm/6">
              <label htmlFor={`person-${person.id}`} className="select-none font-medium text-white">
                {person.name}
              </label>
            </div>
