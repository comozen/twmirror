    ...
    <>
      ...
      */}
      <div className="min-h-full">
        <Disclosure as="nav" className="border-b border-white/10 bg-gray-800/50">
                ...
                <DisclosureButton
                  ...
                  className={classNames(
                    item.current
                      ...
                      : 'border-transparent text-gray-400 hover:border-white/20 hover:bg-white/5 hover:text-gray-200',
