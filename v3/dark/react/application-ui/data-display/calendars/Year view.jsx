        ...
        <div className="flex items-center">
          ...
          <div className="hidden md:ml-4 md:flex md:items-center">
            <Menu as="div" className="relative">
              ...
              <MenuItems
                transition
                className="absolute right-0 z-10 mt-3 w-36 origin-top-right overflow-hidden rounded-md bg-gray-800 outline outline-1 -outline-offset-1 outline-white/5 transition data-[closed]:scale-95 data-[closed]:transform data-[closed]:opacity-0 data-[enter]:duration-100 data-[leave]:duration-75 data-[enter]:ease-out data-[leave]:ease-in"
              >
                <div className="py-1">
                  <MenuItem>
                    <a
          ...
          <div className="ml-6 md:hidden">
            <Menu as="div" className="relative">
              ...
              <MenuItems
                transition
                className="absolute right-0 z-10 mt-3 w-36 origin-top-right divide-y divide-white/10 overflow-hidden rounded-md bg-gray-800 shadow-lg outline outline-1 -outline-offset-1 outline-white/5 transition data-[closed]:scale-95 data-[closed]:transform data-[closed]:opacity-0 data-[enter]:duration-100 data-[leave]:duration-75 data-[enter]:ease-out data-[leave]:ease-in"
              >
                <div className="py-1">
                  <MenuItem>
                    <a
              ...
              <div className="isolate mt-2 grid grid-cols-7 gap-px rounded-lg bg-white/10 text-sm ring-1 ring-white/10">
                {month.days.map((day) => (
                  <button
                    ...
                    className="relative bg-gray-900/75 py-1.5 text-gray-500 first:rounded-tl-lg last:rounded-br-lg hover:bg-gray-900/25 focus:z-10 data-[is-current-month]:bg-gray-900 data-[is-current-month]:text-gray-100 data-[is-current-month]:hover:bg-gray-900/50 [&:nth-child(36)]:rounded-bl-lg [&:nth-child(7)]:rounded-tr-lg"
                  >
                    <time
                      dateTime={day.date}
                      className="mx-auto flex size-7 items-center justify-center rounded-full [[data-is-today]_&]:bg-indigo-500 [[data-is-today]_&]:font-semibold [[data-is-today]_&]:text-white"
                    >
