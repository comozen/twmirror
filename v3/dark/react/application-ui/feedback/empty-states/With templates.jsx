...
export default function Example() {
  return (
    <div className="mx-auto max-w-lg">
      ...
      <p className="mt-1 text-sm text-gray-400">Get started by selecting a template or start from an empty project.</p>
          ...
          <li key={itemIdx}>
            <div className="group relative flex items-start space-x-3 py-4">
              ...
              <div className="shrink-0 self-center">
                <ChevronRightIcon aria-hidden="true" className="size-5 text-gray-500 group-hover:text-gray-400" />
              </div>
            </div>
          </li>
        ))}
