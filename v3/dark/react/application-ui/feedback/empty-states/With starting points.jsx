...
export default function Example() {
  return (
    <div>
      ...
      <ul role="list" className="mt-6 grid grid-cols-1 gap-6 border-y border-white/10 py-6 sm:grid-cols-2">
        {items.map((item, itemIdx) => (
          <li key={itemIdx} className="flow-root">
            <div className="relative -m-2 flex items-center space-x-4 rounded-xl p-2 focus-within:outline focus-within:outline-2 focus-within:outline-indigo-500 hover:bg-white/5">
              <div
