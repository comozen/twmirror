              ...
              <li key={item.name}>
                ...
                >
                  ...
                  {item.count ? (
                    <span
                      aria-hidden="true"
                      className="ml-auto w-9 min-w-max whitespace-nowrap rounded-full bg-gray-800 px-2.5 py-0.5 text-center text-xs/5 font-medium text-gray-400 outline outline-1 -outline-offset-1 outline-white/10"
                    >
                      {item.count}
                    </span>
                  ) : null}
                ...
                >
                  <span
                    className={classNames(
                      ...
                      'flex size-6 shrink-0 items-center justify-center rounded-lg border bg-gray-900/50 text-[0.625rem] font-medium',
                    )}
                  >
                    {item.initial}
                  </span>
