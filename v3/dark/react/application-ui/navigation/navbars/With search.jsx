        ...
        <div className="flex h-16 justify-between">
          <div className="flex px-2 lg:px-0">
            ...
            <div className="hidden lg:ml-6 lg:flex lg:space-x-8">
              ...
              <a
                href="#"
                className="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-400 hover:border-white/20 hover:text-white"
              >
                Team
              </a>
              <a
      ...
      <DisclosurePanel className="lg:hidden">
        <div className="space-y-1 pb-3 pt-2">
          ...
          <DisclosureButton
            as="a"
            href="#"
            className="block border-l-4 border-indigo-500 bg-indigo-600/10 py-2 pl-3 pr-4 text-base font-medium text-indigo-400"
          >
            Dashboard
          </DisclosureButton>
          <DisclosureButton
            as="a"
            href="#"
            className="block border-l-4 border-transparent py-2 pl-3 pr-4 text-base font-medium text-gray-300 hover:border-white/20 hover:bg-white/5 hover:text-white"
          >
            Team
          </DisclosureButton>
          <DisclosureButton
        ...
        <div className="border-t border-white/10 pb-3 pt-4">
          <div className="flex items-center px-4">
            ...
            <button
              type="button"
              className="relative ml-auto shrink-0 rounded-full p-1 text-gray-400 hover:text-white focus:outline focus:outline-2 focus:outline-offset-2"
            >
              <span className="absolute -inset-1.5" />
              <span className="sr-only">View notifications</span>
              <BellIcon aria-hidden="true" className="size-6" />
