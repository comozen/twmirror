                ...
                <li key={item.name}>
                  ...
                  >
                    ...
                    {item.count ? (
                      <span
                        aria-hidden="true"
                        className="ml-auto w-9 min-w-max whitespace-nowrap rounded-full bg-gray-900 px-2.5 py-0.5 text-center text-xs/5 font-medium text-white outline outline-1 -outline-offset-1 outline-white/15"
                      >
                        {item.count}
                      </span>
                    ) : null}
                    ...
                    <span
                      className={classNames(
                        team.current
                          ...
                          : 'border-white/15 text-gray-400 group-hover:border-white/20 group-hover:text-white',
