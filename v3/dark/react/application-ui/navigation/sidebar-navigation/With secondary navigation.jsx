              ...
              {navigation.map((item) => (
                <li key={item.name}>
                  {!item.children ? (
                    ...
                    >
                      <item.icon aria-hidden="true" className="size-6 shrink-0 text-current" />
                      {item.name}
                    </a>
                  ) : (
                    <Disclosure as="div">
                      ...
                      >
                        ...
                        <ChevronRightIcon
                          aria-hidden="true"
                          className="ml-auto size-5 shrink-0 text-gray-400 group-data-[open]:rotate-90"
                        />
                      </DisclosureButton>
                        ...
                        {item.children.map((subItem) => (
                          <li key={subItem.name}>
                            ...
                            <DisclosureButton
                              ...
                              href={subItem.href}
                              className={classNames(
                                subItem.current ? 'bg-white/5 text-white' : 'hover:bg-white/5 hover:text-white',
                                'block rounded-md py-2 pl-9 pr-2 text-sm/6 text-gray-400',
                              )}
                            >
                              {subItem.name}
                            </DisclosureButton>
