                  ...
                  {!item.children ? (
                    <a
                      ...
                      className={classNames(
                        ...
                        'block rounded-md py-2 pl-10 pr-2 text-sm/6 font-semibold text-gray-400',
                      )}
                    >
                      {item.name}
                    </a>
                    ...
                    <Disclosure as="div">
                      ...
                      >
                        <ChevronRightIcon
                          aria-hidden="true"
                          className="size-5 shrink-0 text-gray-400 group-data-[open]:rotate-90"
                        />
                        {item.name}
                      </DisclosureButton>
                        ...
                        {item.children.map((subItem) => (
                          <li key={subItem.name}>
                            <DisclosureButton
                              ...
                              href={subItem.href}
                              className={classNames(
                                subItem.current ? 'bg-white/5' : 'hover:bg-white/5',
