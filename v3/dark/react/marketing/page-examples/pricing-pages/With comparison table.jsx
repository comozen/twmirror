...
export default function Example() {
  ...
  return (
    <div className="bg-gray-900">
                                    ...
                                    >
                                      ...
                                      <dd className="flex items-center justify-end sm:justify-center sm:px-4">
                                        {typeof feature.tiers[tier.name] === 'string' ? (
                                          <span
                                            className={tier.featured ? 'font-semibold text-indigo-400' : 'text-white'}
                                          >
                                          ...
                                          <>
                                            {feature.tiers[tier.name] === true ? (
                                              ...
                                              <XMarkIconMini
                                                aria-hidden="true"
                                                className="mx-auto size-5 text-gray-600"
                                              />
                                            )}
      ...
      {/* Footer */}
      <footer className="mx-auto max-w-7xl px-6 pb-8 pt-24 sm:pt-56 lg:px-8">
