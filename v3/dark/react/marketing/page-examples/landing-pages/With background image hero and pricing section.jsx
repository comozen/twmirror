    ...
    <div className="bg-gray-900">
      ...
      <main>
        ...
        <div className="relative z-10 mb-20 mt-32 sm:mb-24 sm:mt-56 xl:mb-0">
          ...
          <div className="bg-gray-800/50 pb-20 outline outline-1 outline-white/5 sm:pb-24 xl:pb-0">
        ...
        <div className="relative isolate mt-32 px-6 sm:mt-56 lg:px-8">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-pretty text-center text-lg/8 text-gray-400">
