      ...
      <main className="isolate">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-16 flex justify-center">
            <p className="relative rounded-full bg-gray-800/25 px-4 py-1.5 text-sm/6 text-gray-400 ring-1 ring-inset ring-white/10">
        ...
        <div className="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden bg-black px-6 py-20 after:pointer-events-none after:absolute after:inset-0 after:ring-1 after:ring-inset after:ring-white/10 sm:rounded-3xl sm:px-10 sm:py-24 after:sm:rounded-3xl md:px-12 lg:px-20">
            <img
              alt=""
            ...
            <div aria-hidden="true" className="absolute -left-80 -top-56 transform-gpu blur-3xl">
              <div
                ...
                className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-r from-[#ff4694] to-[#776fff] opacity-[0.30]"
              />
            </div>
            <div
              aria-hidden="true"
            ...
            >
              <div
                ...
                className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-r from-[#ff4694] to-[#776fff] opacity-20"
              />
            </div>
        ...
        <div className="py-24 sm:pt-48">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-pretty text-center text-lg/8 text-gray-400 sm:text-xl/8">
              ...
              {tiers.map((tier, tierIdx) => (
                ...
                >
                  <div>
                    ...
                    <ul role="list" className="mt-8 space-y-3 text-sm/6 text-gray-400">
                  ...
                  <a
                    ...
                    className={classNames(
                      ...
                      'mt-8 block rounded-md px-3 py-2 text-center text-sm/6 font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500',
                    )}
                  >
                    Buy plan
                  </a>
        ...
        <div className="relative -z-10 mt-32 px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#"
                className="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
              >
                Get started
              </a>
              <a href="#" className="text-sm/6 font-semibold text-white">
