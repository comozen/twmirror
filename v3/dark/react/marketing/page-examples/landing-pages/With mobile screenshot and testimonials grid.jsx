    ...
    <div className="bg-gray-900">
      ...
      <main>
            ...
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              <div className="flex">
                <div className="relative flex items-center gap-x-4 rounded-full bg-white/5 px-4 py-1 text-sm/6 text-gray-300 ring-1 ring-white/10 hover:ring-white/20">
                  <span className="font-semibold text-indigo-400">We’re hiring</span>
        ...
        <div className="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
          <div className="relative isolate overflow-hidden bg-gray-800/50 px-6 py-20 after:pointer-events-none after:absolute after:inset-0 after:ring-1 after:ring-inset after:ring-white/10 sm:rounded-3xl sm:px-10 sm:py-24 after:sm:rounded-3xl lg:py-24 xl:px-24">
        ...
        {/* Newsletter section */}
        <div className="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
          <div className="relative isolate overflow-hidden bg-gray-800 px-6 py-24 after:pointer-events-none after:absolute after:inset-0 after:ring-1 after:ring-inset after:ring-white/15 sm:rounded-3xl sm:px-24 after:sm:rounded-3xl xl:py-32">
            ...
            <form className="mx-auto mt-10 flex max-w-md gap-x-4">
              ...
              <input
                ...
                autoComplete="email"
                className="min-w-0 flex-auto rounded-md bg-white/5 px-3.5 py-2 text-base text-white outline outline-1 -outline-offset-1 outline-white/20 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6"
              />
              <button
                type="submit"
        ...
        <div className="relative isolate mt-32 sm:mt-56 sm:pt-32">
          <svg
            aria-hidden="true"
            className="absolute inset-0 -z-10 hidden size-full stroke-white/10 [mask-image:radial-gradient(64rem_64rem_at_top,white,transparent)] sm:block"
          >
            <defs>
              <pattern
                x="50%"
      ...
      <footer className="mt-32 sm:mt-56">
        <div className="mx-auto max-w-7xl border-t border-white/10 px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
