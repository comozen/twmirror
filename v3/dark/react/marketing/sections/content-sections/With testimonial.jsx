      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:mt-10 lg:max-w-none lg:grid-cols-12">
          <div className="relative lg:order-last lg:col-span-5">
            <svg
              aria-hidden="true"
              className="absolute left-1 top-[-40rem] -z-10 h-[64rem] w-[175.5rem] -translate-x-1/2 stroke-white/10 [mask-image:radial-gradient(64rem_64rem_at_111.5rem_0%,white,transparent)]"
            >
              <defs>
                <pattern
            ...
            <figure className="border-l border-indigo-400 pl-8">
              ...
              <figcaption className="mt-8 flex gap-x-4">
                <img
                  ...
                  className="mt-1 size-10 flex-none rounded-full bg-gray-800"
                />
