    ...
    <div className="bg-gray-900 px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base/7 text-gray-300">
        ...
        <div className="mt-10 max-w-2xl text-gray-400">
          ...
          <ul role="list" className="mt-8 max-w-xl space-y-8 text-gray-400">
            ...
            <li className="flex gap-x-3">
              <CheckCircleIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-400" />
              <span>
                <strong className="font-semibold text-white">Events.</strong> Ac tincidunt sapien vehicula erat auctor
          ...
          <h2 className="mt-16 text-pretty text-3xl font-semibold tracking-tight text-white">
        ...
        <div className="mt-16 max-w-2xl text-gray-400">
          <h2 className="text-pretty text-3xl font-semibold tracking-tight text-white">
