      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-4">
            <div className="relative overflow-hidden rounded-3xl bg-gray-800 px-6 pb-9 pt-64 after:pointer-events-none after:absolute after:inset-0 after:rounded-3xl after:ring-1 after:ring-inset after:ring-white/10 sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
              <img
                alt=""
          ...
          <div>
            <div className="text-base/7 text-gray-400 lg:max-w-lg">
              <p className="text-base/7 font-semibold text-indigo-400">Company values</p>
            ...
            <div className="mt-10 flex">
              <a href="#" className="text-base/7 font-semibold text-indigo-400 hover:text-indigo-300">
