...
export default function Example() {
  return (
    <section className="bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
      <figure className="mx-auto max-w-2xl">
        <p className="sr-only">5 out of 5 stars</p>
        <div className="flex gap-x-1 text-indigo-400">
        ...
        <figcaption className="mt-10 flex items-center gap-x-6">
          ...
          <div className="text-sm/6">
            ...
            <div className="mt-0.5 text-gray-400">CEO of Workcation</div>
          </div>
        </figcaption>
      </figure>
    </section>
