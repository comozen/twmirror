      ...
      <div className="mx-auto max-w-xl lg:max-w-4xl">
        ...
        <div className="mt-16 flex flex-col gap-16 sm:gap-y-20 lg:flex-row">
              ...
              <div>
                ...
                <div className="mt-2.5">
                  <input
                    ...
                    className="block w-full rounded-md bg-white/5 px-3.5 py-2 text-base text-white outline outline-1 -outline-offset-1 outline-white/10 backdrop-blur placeholder:text-gray-500 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500"
                  />
                </div>
              </div>
              <div>
          ...
          <div className="lg:mt-6 lg:w-80 lg:flex-none">
            <img
              alt=""
              src="/plus-assets/img/logos/workcation-logo-indigo-500.svg"
