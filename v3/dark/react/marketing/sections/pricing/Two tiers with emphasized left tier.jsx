        ...
        {tiers.map((tier, tierIdx) => (
          <div
            ...
            className={classNames(
              tier.featured ? 'relative bg-gray-800' : 'bg-gray-800/50 sm:mx-8 lg:mx-0',
              tier.featured
                ? ''
                : tierIdx === 0
          ...
          >
            ...
            <a
              ...
              className={classNames(
                tier.featured
                  ? 'bg-indigo-500 text-white shadow hover:bg-indigo-400'
                  : 'bg-white/10 text-white ring-1 ring-inset ring-white/5 hover:bg-white/20 focus-visible:outline-white/75',
                'mt-8 block rounded-md px-3.5 py-2.5 text-center text-sm font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 sm:mt-10',
              )}
            >
              Get started today
            </a>
