        ...
        <div className="mx-auto mt-12 max-w-md space-y-8 sm:mt-16 lg:hidden">
          {tiers.map((tier) => (
            ...
            >
              ...
              <ul role="list" className="mt-10 space-y-4 text-sm/6 text-gray-200">
          ...
          <div className="relative -mx-8">
            {tiers.some((tier) => tier.mostPopular) ? (
              <div className="absolute inset-x-4 inset-y-0 -z-10 flex">
                ...
                >
                  <div className="w-full rounded-t-xl border-x border-t border-white/10 bg-gray-800/50" />
                </div>
              </div>
            ) : null}
              ...
              <tbody>
                ...
                {sections.map((section, sectionIdx) => (
                  <Fragment key={section.name}>
                    ...
                    {section.features.map((feature) => (
                      <tr key={feature.name}>
                        <th scope="row" className="py-4 text-sm/6 font-normal text-gray-200">
                          {feature.name}
                        ...
                        {tiers.map((tier) => (
                          <td key={tier.id} className="px-6 py-4 xl:px-8">
                            {typeof feature.tiers[tier.name] === 'string' ? (
                              <div className="text-center text-sm/6 text-gray-400">{feature.tiers[tier.name]}</div>
                            ) : (
                              <>
