    ...
    <div className="bg-gray-900">
      <main className="mx-auto w-full max-w-7xl px-6 pb-16 pt-10 sm:pb-24 lg:px-8">
        ...
        <div className="mx-auto mt-16 flow-root max-w-lg sm:mt-20">
          ...
          <ul role="list" className="-mt-6 divide-y divide-white/10 border-b border-white/10">
            {links.map((link, linkIdx) => (
              <li key={linkIdx} className="relative flex gap-x-6 py-6">
                <div className="flex size-10 flex-none items-center justify-center rounded-lg bg-gray-800/50 shadow-sm outline outline-1 -outline-offset-1 outline-white/10">
                  <link.icon aria-hidden="true" className="size-6 text-indigo-400" />
                </div>
                <div className="flex-auto">
                  ...
                  <p className="mt-2 text-sm/6 text-gray-400">{link.description}</p>
                </div>
      ...
      <footer className="border-t border-white/10 py-6 sm:py-10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-center gap-8 px-6 sm:flex-row lg:px-8">
          <p className="text-sm/7 text-gray-500">&copy; Your Company, Inc. All rights reserved.</p>
          <div className="hidden sm:block sm:h-7 sm:w-px sm:flex-none sm:bg-gray-700" />
          <div className="flex gap-x-4">
            {social.map((item, itemIdx) => (
              <a key={itemIdx} href={item.href} className="text-gray-500 hover:text-gray-400">
