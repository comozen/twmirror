            ...
            <tbody class="divide-y divide-white/10 bg-gray-900">
              <tr v-for="person in people" :key="person.email">
                <td class="whitespace-nowrap py-5 pl-4 pr-3 text-sm sm:pl-0">
                  <div class="flex items-center">
                    <div class="size-11 shrink-0">
                      <img class="size-11 rounded-full outline outline-1 outline-white/10" :src="person.image" alt="" />
                    </div>
                    <div class="ml-4">
                ...
                <td class="whitespace-nowrap px-3 py-5 text-sm text-gray-400">
                  <div class="text-white">{{ person.title }}</div>
                  <div class="mt-1 text-gray-400">{{ person.department }}</div>
                </td>
                <td class="whitespace-nowrap px-3 py-5 text-sm text-gray-400">
                  <span class="inline-flex items-center rounded-md bg-green-900/30 px-2 py-1 text-xs font-medium text-green-400 ring-1 ring-inset ring-green-500/50">Active</span>
                </td>
