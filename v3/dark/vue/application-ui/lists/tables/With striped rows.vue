        ...
        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
          <table class="relative min-w-full divide-y divide-white/15">
            ...
            <tbody class="bg-gray-900">
              <tr v-for="person in people" :key="person.email" class="even:bg-gray-800/50">
                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-white sm:pl-3">{{ person.name }}</td>
