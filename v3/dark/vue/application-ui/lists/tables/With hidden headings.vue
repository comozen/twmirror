                    ...
                    <div class="flex gap-x-6">
                      ...
                      <div class="flex-auto">
                        <div class="flex items-start gap-x-3">
                          ...
                          <div v-if="transaction.status === 'Paid'" class="rounded-md bg-green-900/30 px-2 py-1 text-xs font-medium text-green-400 ring-1 ring-inset ring-green-500/20">{{ transaction.status }}</div>
                          <div v-if="transaction.status === 'Withdraw'" class="rounded-md bg-gray-700/50 px-2 py-1 text-xs font-medium text-gray-400 ring-1 ring-inset ring-gray-500/20">{{ transaction.status }}</div>
                          <div v-if="transaction.status === 'Overdue'" class="rounded-md bg-red-900/30 px-2 py-1 text-xs font-medium text-red-400 ring-1 ring-inset ring-red-500/20">{{ transaction.status }}</div>
                        </div>
