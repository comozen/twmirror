    ...
    <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
      ...
      <div class="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
        <div class="flex p-px lg:col-span-4">
          <div class="w-full overflow-hidden rounded-lg bg-gray-800 outline outline-1 outline-white/15 max-lg:rounded-t-[2rem] lg:rounded-tl-[2rem]">
            <img class="h-80 object-cover object-left" src="/plus-assets/img/component-images/dark-bento-02-releases.png" alt="" />
            <div class="p-10">
        ...
        <div class="flex p-px lg:col-span-2">
          <div class="w-full overflow-hidden rounded-lg bg-gray-800 outline outline-1 outline-white/15 lg:rounded-tr-[2rem]">
            <img class="h-80 object-cover" src="/plus-assets/img/component-images/dark-bento-02-integrations.png" alt="" />
            <div class="p-10">
        ...
        <div class="flex p-px lg:col-span-2">
          <div class="w-full overflow-hidden rounded-lg bg-gray-800 outline outline-1 outline-white/15 lg:rounded-bl-[2rem]">
            <img class="h-80 object-cover" src="/plus-assets/img/component-images/dark-bento-02-security.png" alt="" />
            <div class="p-10">
        ...
        <div class="flex p-px lg:col-span-4">
          <div class="w-full overflow-hidden rounded-lg bg-gray-800 outline outline-1 outline-white/15 max-lg:rounded-b-[2rem] lg:rounded-br-[2rem]">
            <img class="h-80 object-cover object-left" src="/plus-assets/img/component-images/dark-bento-02-performance.png" alt="" />
            <div class="p-10">
