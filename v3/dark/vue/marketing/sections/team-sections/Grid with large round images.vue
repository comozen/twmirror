  ...
  <div class="bg-gray-900 py-32">
    <div class="mx-auto max-w-7xl px-6 text-center lg:px-8">
      <div class="mx-auto max-w-2xl">
        <h2 class="text-balance text-4xl font-semibold tracking-tight text-white sm:text-5xl">Meet our leadership</h2>
      ...
      <ul role="list" class="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
        <li v-for="person in people" :key="person.name">
          <img class="mx-auto size-56 rounded-full outline outline-1 -outline-offset-1 outline-white/10" :src="person.imageUrl" alt="" />
