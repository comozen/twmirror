    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <ul role="list" class="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
        <li v-for="person in people" :key="person.name">
          <img class="aspect-[3/2] w-full rounded-2xl object-cover outline outline-1 -outline-offset-1 outline-white/10" :src="person.imageUrl" alt="" />
          ...
          <ul role="list" class="mt-6 flex gap-x-6">
            <li>
              <a :href="person.xUrl" class="text-gray-400 hover:text-gray-200">
            ...
            <li>
              <a :href="person.linkedinUrl" class="text-gray-400 hover:text-gray-200">
