  ...
  <div class="bg-gray-900 py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto grid max-w-2xl grid-cols-1 gap-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-5">
        <h2 class="col-span-2 text-pretty text-4xl font-semibold tracking-tight text-white sm:text-5xl">Stay on top of customer support</h2>
        <dl class="col-span-3 grid grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2">
          <div v-for="feature in features" :key="feature.name">
            ...
            <dd class="mt-1 text-base/7 text-gray-400">{{ feature.description }}</dd>
          </div>
        </dl>
      </div>
    </div>
