  ...
  <div class="overflow-hidden bg-gray-900 py-24 sm:py-32">
    <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
      <div class="max-w-4xl">
        ...
        <h1 class="mt-2 text-pretty text-4xl font-semibold tracking-tight text-white sm:text-5xl">On a mission to empower remote teams</h1>
        <p class="mt-6 text-balance text-xl/8 text-gray-300">Aliquet nec orci mattis amet quisque ullamcorper neque, nibh sem. At arcu, sit dui mi, nibh dui, diam eget aliquam. Quisque id at vitae feugiat egestas.</p>
      </div>
      <section class="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
        <div class="lg:pr-8">
          <h2 class="text-pretty text-2xl font-semibold tracking-tight text-white">Our mission</h2>
          <p class="mt-6 text-base/7 text-gray-400">Faucibus commodo massa rhoncus, volutpat. Dignissim sed eget risus enim. Mattis mauris semper sed amet vitae sed turpis id. Id dolor praesent donec est. Odio penatibus risus viverra tellus varius sit neque erat velit. Faucibus commodo massa rhoncus, volutpat. Dignissim sed eget risus enim. Mattis mauris semper sed amet vitae sed turpis id.</p>
          <p class="mt-8 text-base/7 text-gray-400">Et vitae blandit facilisi magna lacus commodo. Vitae sapien duis odio id et. Id blandit molestie auctor fermentum dignissim. Lacus diam tincidunt ac cursus in vel. Mauris varius vulputate et ultrices hac adipiscing egestas. Iaculis convallis ac tempor et ut. Ac lorem vel integer orci.</p>
        </div>
        <div class="pt-16 lg:row-span-2 lg:-mr-16 xl:mr-auto">
          <div class="-mx-8 grid grid-cols-2 gap-4 sm:-mx-16 sm:grid-cols-4 lg:mx-0 lg:grid-cols-2 xl:gap-8">
            <div class="aspect-square overflow-hidden rounded-xl outline outline-1 -outline-offset-1 outline-white/10">
            ...
            <div class="-mt-8 aspect-square overflow-hidden rounded-xl outline outline-1 -outline-offset-1 outline-white/10 lg:-mt-40">
        ...
        <div class="max-lg:mt-16 lg:col-span-1">
          <p class="text-base/7 font-semibold text-gray-400">The numbers</p>
          ...
          <dl class="mt-6 grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
            <div class="flex flex-col gap-y-2 border-b border-dotted border-gray-700 pb-4">
              <dt class="text-sm/6 text-gray-400">Raised</dt>
              <dd class="order-first text-6xl font-semibold tracking-tight text-white">$<span>150</span>M</dd>
            </div>
            <div class="flex flex-col gap-y-2 border-b border-dotted border-gray-700 pb-4">
              <dt class="text-sm/6 text-gray-400">Companies</dt>
              <dd class="order-first text-6xl font-semibold tracking-tight text-white"><span>30</span>K</dd>
            </div>
            <div class="flex flex-col gap-y-2 max-sm:border-b max-sm:border-dotted max-sm:border-gray-700 max-sm:pb-4">
              <dt class="text-sm/6 text-gray-400">Deals Closed</dt>
              <dd class="order-first text-6xl font-semibold tracking-tight text-white"><span>1.5</span>M</dd>
            </div>
            <div class="flex flex-col gap-y-2">
              <dt class="text-sm/6 text-gray-400">Leads Generated</dt>
              <dd class="order-first text-6xl font-semibold tracking-tight text-white"><span>200</span>M</dd>
            </div>
          </dl>
        </div>
      </section>
