  ...
  <div class="bg-gray-900">
    ...
    <main>
      ...
      <form class="group/tiers pt-24 sm:pt-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div class="isolate mx-auto mt-10 grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            <div v-for="tier in pricing.tiers" :key="tier.id" class="group/tier rounded-3xl bg-gray-800/50 p-8 ring-1 ring-white/15 data-[featured]:ring-2 data-[featured]:ring-indigo-400 xl:p-10" :data-featured="tier.featured ? 'true' : undefined">
      ...
      <div class="mx-auto mt-24 max-w-7xl px-6 sm:mt-56 lg:px-8">
        <div class="mx-auto grid max-w-2xl grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div class="flex flex-col pb-10 sm:pb-16 lg:pb-0 lg:pr-8 xl:pr-20">
            <img class="h-12 self-start" src="/plus-assets/img/logos/tuple-logo-white.svg" alt="" />
            <figure class="mt-10 flex flex-auto flex-col justify-between">
              <blockquote class="text-lg/8 text-gray-100">
          ...
          <div class="flex flex-col border-t border-white/10 pt-10 sm:pt-16 lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0 xl:pl-20">
            <img class="h-12 self-start" src="/plus-assets/img/logos/reform-logo-white.svg" alt="" />
            <figure class="mt-10 flex flex-auto flex-col justify-between">
              <blockquote class="text-lg/8 text-gray-100">
      ...
      <div class="mx-auto mt-24 max-w-7xl px-6 sm:mt-56 lg:px-8">
        ...
        <p class="mt-6 max-w-2xl text-base/7 text-gray-400">Have a different question and can’t find the answer you’re looking for? Reach out to our support team by <a href="#" class="font-semibold text-indigo-400 hover:text-indigo-300">sending us an email</a> and we’ll get back to you as soon as we can.</p>
        <div class="mt-20">
          <dl class="space-y-16 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-16 sm:space-y-0 lg:gap-x-10">
            <div v-for="faq in faqs" :key="faq.id">
              ...
              <dd class="mt-2 text-base/7 text-gray-400">{{ faq.answer }}</dd>
            </div>
          </dl>
        </div>
      </div>
