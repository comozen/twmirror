    ...
    <div class="mx-auto max-w-2xl px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8">
      ...
      <div class="mt-11 grid grid-cols-1 items-start gap-x-6 gap-y-16 sm:mt-16 sm:grid-cols-2 lg:grid-cols-4 lg:gap-x-8">
        <div v-for="feature in features" :key="feature.name" class="flex flex-col-reverse">
          ...
          <img :src="feature.imageSrc" :alt="feature.imageAlt" class="aspect-square w-full rounded-lg bg-gray-100 object-cover" />
        </div>
      </div>
    </div>
  </div>
...
const features = [
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/product-feature-08-detail-01.jpg',
  ...
  },
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/product-feature-08-detail-02.jpg',
  ...
  },
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/product-feature-08-detail-03.jpg',
  ...
  },
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/product-feature-08-detail-04.jpg',
