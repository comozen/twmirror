<template>
  ...
  <main class="relative lg:min-h-full">
    <div class="h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12">
      <img src="/plus-assets/img/ecommerce-images/confirmation-page-06-hero.jpg" alt="TODO" class="size-full object-cover" />
    </div>
...
const products = [
  {
    ...
    color: 'Charcoal',
    size: 'L',
    imageSrc: '/plus-assets/img/ecommerce-images/confirmation-page-06-product-01.jpg',
  ...
  },
  {
    ...
    color: 'Peach',
    size: 'S',
    imageSrc: '/plus-assets/img/ecommerce-images/confirmation-page-06-product-02.jpg',
