    ...
    products: [
      {
        ...
        imageSrc: '/plus-assets/img/ecommerce-images/order-history-page-02-product-01.jpg',
      ...
      },
      {
        ...
        price: '$28.00',
        status: 'Delivered Jan 25, 2021',
        imageSrc: '/plus-assets/img/ecommerce-images/order-history-page-02-product-02.jpg',
      ...
      },
      {
        ...
        price: '$140.00',
        status: 'Delivered Jan 25, 2021',
        imageSrc: '/plus-assets/img/ecommerce-images/order-history-page-02-product-03.jpg',
        imageAlt:
    ...
    products: [
      {
        ...
        imageSrc: '/plus-assets/img/ecommerce-images/order-history-page-02-product-04.jpg',
        imageAlt:
      ...
      },
      {
        ...
        price: '$35.00',
        status: 'Delivered Jan 7, 2021',
        imageSrc: '/plus-assets/img/ecommerce-images/order-history-page-02-product-05.jpg',
