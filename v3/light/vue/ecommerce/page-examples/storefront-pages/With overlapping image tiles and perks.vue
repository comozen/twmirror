        ...
        <div aria-hidden="true" class="absolute inset-0 hidden sm:flex sm:flex-col">
          <div class="relative w-full flex-1 bg-gray-800">
            <div class="absolute inset-0 overflow-hidden">
              <img src="/plus-assets/img/ecommerce-images/home-page-04-hero-full-width.jpg" alt="" class="size-full object-cover" />
            </div>
...
const collections = [
  {
    name: "Women's",
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-04-collection-01.jpg',
    imageAlt: 'Woman wearing a comfortable cotton t-shirt.',
  },
  {
    name: "Men's",
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-04-collection-02.jpg',
    imageAlt: 'Man wearing a comfortable and casual cotton t-shirt.',
  },
  {
    name: 'Desk Accessories',
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-04-collection-03.jpg',
...
const trendingProducts = [
  {
    ...
    price: '$75',
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-04-trending-product-02.jpg',
  ...
  },
  {
    ...
    price: '$70',
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-04-trending-product-03.jpg',
  ...
  },
  {
    ...
    price: '$27',
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-04-trending-product-04.jpg',
  ...
  },
  {
    ...
    price: '$149',
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-04-trending-product-01.jpg',
...
const perks = [
  {
    name: 'Free returns',
    imageUrl: '/plus-assets/img/ecommerce/icons/icon-returns-light.svg',
    description: 'Not what you expected? Place it back in the parcel and attach the pre-paid postage stamp.',
  },
  {
    name: 'Same day delivery',
    imageUrl: '/plus-assets/img/ecommerce/icons/icon-calendar-light.svg',
    description:
      'We offer a delivery service that has never been done before. Checkout today and receive your products within hours.',
  },
  {
    name: 'All year discount',
    imageUrl: '/plus-assets/img/ecommerce/icons/icon-gift-card-light.svg',
    description: 'Looking for a deal? You can use the code "ALLYEAR" at checkout and get money off all year round.',
  },
  {
    name: 'For the planet',
    imageUrl: '/plus-assets/img/ecommerce/icons/icon-planet-light.svg',
