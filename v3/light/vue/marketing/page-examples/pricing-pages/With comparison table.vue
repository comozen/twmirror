  ...
  <div class="bg-white">
    ...
    <main>
      ...
      <form class="group/tiers isolate overflow-hidden">
        <div class="flow-root border-b border-b-transparent bg-gray-900 pb-16 pt-24 sm:pt-32 lg:pb-0">
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="relative mx-auto mt-10 grid max-w-md grid-cols-1 gap-y-8 lg:mx-0 lg:-mb-14 lg:max-w-none lg:grid-cols-3">
              ...
              <div v-for="tier in pricing.tiers" :key="tier.id" :class="[tier.featured ? 'z-10 bg-white shadow-xl outline outline-1 outline-gray-900/10' : 'bg-gray-800/80 outline outline-1 -outline-offset-1 outline-white/10 lg:bg-transparent lg:pb-14 lg:outline-0', 'group/tier relative rounded-2xl']" :data-featured="tier.featured ? 'true' : undefined">
                ...
                <div v-for="section in pricing.sections" :key="section.name">
                  ...
                  <div class="relative -mx-8 mt-10">
                    ...
                    <div class="absolute inset-x-8 inset-y-0 grid grid-cols-4 gap-x-8 before:block" aria-hidden="true">
                      <div class="size-full rounded-lg bg-white shadow-sm" />
                      <div class="size-full rounded-lg bg-white shadow-sm" />
                      <div class="size-full rounded-lg bg-white shadow-sm" />
                    </div>
