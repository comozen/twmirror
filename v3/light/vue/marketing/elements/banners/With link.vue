<template>
  <div class="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
    ...
    <p class="text-sm/6 text-gray-900">
      GeneriCon 2023 is on June 7 – 9 in Denver. <a href="#" class="whitespace-nowrap font-semibold text-gray-900 hover:text-gray-700">Get your ticket&nbsp;<span aria-hidden="true">&rarr;</span></a>
    </p>
