<template>
  <div class="flex">
    <div>
      <h4 class="text-lg font-bold text-gray-900">Lorem ipsum</h4>
      <p class="mt-1 text-gray-500">Repudiandae sint consequuntur vel. Amet ut nobis explicabo numquam expedita quia omnis voluptatem. Minus quidem ipsam quia iusto.</p>
    </div>
