        ...
        <div class="relative pb-8">
          ...
          <div class="relative flex items-start space-x-3">
            <template v-if="activityItem.type === 'comment'">
              <div class="relative">
                <img class="flex size-10 items-center justify-center rounded-full bg-gray-400 outline outline-1 -outline-offset-1 outline-black/5 ring-8 ring-white" :src="activityItem.imageUrl" alt="" />
