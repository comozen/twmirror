                    ...
                    <div class="flex gap-x-6">
                      ...
                      <div class="flex-auto">
                        <div class="flex items-start gap-x-3">
                          ...
                          <div v-if="transaction.status === 'Paid'" class="rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">{{ transaction.status }}</div>
                          <div v-if="transaction.status === 'Withdraw'" class="rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10">{{ transaction.status }}</div>
                          <div v-if="transaction.status === 'Overdue'" class="rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10">{{ transaction.status }}</div>
                        </div>
