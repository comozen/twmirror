  ...
  <div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
      ...
      <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
        <button type="button" class="block rounded-md bg-indigo-600 px-3 py-1.5 text-center text-sm/6 font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add user</button>
      </div>
    </div>
      ...
      <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
          <div class="group/table relative">
            <div class="absolute left-14 top-0 z-10 hidden h-12 items-center space-x-3 bg-white group-has-[:checked]/table:flex sm:left-12">
            ...
            <table class="relative min-w-full table-fixed divide-y divide-gray-300">
              <thead>
                <tr>
                  ...
                  <th scope="col" class="min-w-48 py-3.5 pr-3 text-left text-sm font-semibold text-gray-900">Name</th>
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr v-for="person in people" :key="person.email" class="group has-[:checked]:bg-gray-50">
                  <td class="relative px-7 sm:w-12 sm:px-6">
                    <div className="hidden group-has-[:checked]:block absolute inset-y-0 left-0 w-0.5 bg-indigo-600" />
                  ...
                  <td class="whitespace-nowrap py-4 pr-3 text-sm font-medium text-gray-900 group-has-[:checked]:text-indigo-600">
                    {{ person.name }}
                  </td>
