          ...
          <table class="min-w-full border-separate border-spacing-0">
            <thead>
              <tr>
                ...
                <th scope="col" class="sticky top-0 z-10 hidden border-b border-gray-300 bg-white/75 px-3 py-3.5 text-left text-sm font-semibold text-gray-900 backdrop-blur backdrop-filter sm:table-cell">Title</th>
            ...
            <tbody>
              <tr v-for="(person, personIdx) in people" :key="person.email">
                ...
                <td :class="[personIdx !== people.length - 1 ? 'border-b border-gray-200' : '', 'whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-8 lg:pr-8']">
