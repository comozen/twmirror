            ...
            <tr key={item.commit}>
              ...
              <td className="hidden py-4 pl-0 pr-4 sm:table-cell sm:pr-8">
                <div className="flex gap-x-3">
                  ...
                  <div className="rounded-md bg-gray-100 px-2 py-1 text-xs font-medium text-gray-600 outline outline-1 outline-gray-200">
                    {item.branch}
                  </div>
                </div>
              </td>
              ...
              <td className="hidden py-4 pl-0 pr-8 text-sm/6 text-gray-500 md:table-cell lg:pr-20">{item.duration}</td>
