            ...
            >
              <div className="flex items-center">
                <div className="grid size-6 shrink-0 place-items-center rounded-full bg-gray-300 [[data-focus]_&]:bg-white">
                  <UserIcon className="size-4 fill-white [[data-focus]_&]:fill-indigo-600" aria-hidden="true" />
                </div>
            ...
            >
              <div className="flex items-center">
                <img
                  src={person.imageUrl}
                  alt=""
                  className="size-6 shrink-0 rounded-full bg-gray-100 outline outline-1 -outline-offset-1 outline-black/5"
                />
