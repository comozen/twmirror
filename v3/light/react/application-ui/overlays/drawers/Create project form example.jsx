                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="ml-3 flex h-7 items-center">
                          <button
                            ...
                            className="relative rounded-md text-indigo-200 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                          >
                                ...
                                {team.map((person) => (
                                  ...
                                  >
                                    <img
                                      alt={person.name}
                                      src={person.imageUrl}
                                      className="inline-block size-8 rounded-full bg-gray-100 outline outline-1 -outline-offset-1 outline-black/5"
                                    />
                                  </a>
                                ))}
                                <button
