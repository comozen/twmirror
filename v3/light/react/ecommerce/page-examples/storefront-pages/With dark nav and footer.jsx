    ...
    <div className="bg-white">
      ...
      <div className="relative bg-gray-900">
        ...
        <div aria-hidden="true" className="absolute inset-0 overflow-hidden">
          <img
            alt=""
            src="/plus-assets/img/ecommerce-images/home-page-01-hero-full-width.jpg"
                  ...
                  <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="hidden lg:flex lg:flex-1 lg:items-center">
                      <a href="#">
                        ...
                        <img
                          alt=""
                          src="/plus-assets/img/logos/mark.svg?color=white"
        ...
        >
          <div className="relative overflow-hidden rounded-lg">
            <div className="absolute inset-0">
              <img
                alt=""
                src="/plus-assets/img/ecommerce-images/home-page-01-feature-section-01.jpg"
                className="size-full object-cover"
              />
            </div>
        ...
        <section aria-labelledby="comfort-heading" className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="relative overflow-hidden rounded-lg">
            <div className="absolute inset-0">
              <img
                alt=""
                src="/plus-assets/img/ecommerce-images/home-page-01-feature-section-02.jpg"
                className="size-full object-cover"
              />
            </div>
            <div className="relative bg-gray-900/75 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
