        ...
        <div className="flex flex-col border-b border-gray-200 lg:border-0">
          ...
          <div className="relative">
            ...
            <div className="h-48 w-full sm:h-64 lg:absolute lg:right-0 lg:top-0 lg:h-full lg:w-1/2">
              <img
                alt=""
                src="/plus-assets/img/ecommerce-images/home-page-02-hero-half-width.jpg"
        ...
        <div className="relative overflow-hidden">
          ...
          <div aria-hidden="true" className="absolute inset-0">
            <div className="absolute inset-0 mx-auto max-w-7xl overflow-hidden xl:px-8">
              <img
                alt=""
                src="/plus-assets/img/ecommerce-images/home-page-02-sale-full-width.jpg"
                className="size-full object-cover"
              />
            </div>
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-x-6 xl:gap-x-8">
              ...
              <div className="relative mt-6 flex items-center px-6 py-12 sm:px-10 sm:py-16 lg:mt-0">
                <div className="absolute inset-0 overflow-hidden rounded-lg">
                  <img
                    alt=""
                    src="/plus-assets/img/ecommerce-images/footer-02-exclusive-sale.jpg"
