...
export default function Example() {
  ...
  return (
    <div className="bg-white">
      ...
      <main className="relative isolate">
        ...
        <div className="mt-32 sm:mt-40 xl:mx-auto xl:max-w-7xl xl:px-8">
          <img
            ...
            className="aspect-[9/4] w-full object-cover outline outline-1 -outline-offset-1 outline-black/5 xl:rounded-3xl"
          />
        </div>
            ...
            {values.map((value) => (
              <div key={value.name} className="relative pl-9">
                <dt className="inline font-semibold text-gray-900">
                  <value.icon aria-hidden="true" className="absolute left-1 top-1 size-5 text-indigo-600" />
                  {value.name}
                </dt>{' '}
            ...
            {team.map((person) => (
              <li key={person.name}>
                <img
                  alt=""
                  src={person.imageUrl}
                  className="aspect-[14/13] w-full rounded-2xl object-cover outline outline-1 -outline-offset-1 outline-black/5"
                />
      ...
      {/* Footer */}
      <footer className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
