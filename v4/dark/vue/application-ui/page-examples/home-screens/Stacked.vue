    ...
    <div class="relative isolate overflow-hidden pt-16">
      ...
      <header class="pt-6 pb-4 sm:pb-6">
        <div class="mx-auto flex max-w-7xl flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
          ...
          <div class="order-last flex w-full gap-x-8 text-sm/6 font-semibold sm:order-0 sm:w-auto sm:border-l sm:border-white/10 sm:pl-6 sm:text-sm/7">
          ...
          <a href="#" class="ml-auto flex items-center gap-x-1 rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
      ...
      <div class="absolute top-full left-0 -z-10 mt-96 origin-top-left translate-y-40 -rotate-90 transform-gpu opacity-10 blur-3xl sm:left-1/2 sm:-mt-10 sm:-ml-96 sm:translate-y-0 sm:rotate-0 sm:opacity-30" aria-hidden="true">
                  ...
                  <template v-for="day in days" :key="day.dateTime">
                    <tr class="text-sm/6 text-white">
                      <th scope="colgroup" colspan="3" class="relative isolate py-2 font-semibold">
                        ...
                        <div class="absolute inset-y-0 right-full -z-10 w-screen border-b border-white/10 bg-white/2.5" />
                        <div class="absolute inset-y-0 left-0 -z-10 w-screen border-b border-white/10 bg-white/2.5" />
                      </th>
                    </tr>
                    <tr v-for="transaction in day.transactions" :key="transaction.id">
                      <td class="relative py-5 pr-6">
                        ...
                        <div class="absolute right-full bottom-0 h-px w-screen bg-white/5" />
