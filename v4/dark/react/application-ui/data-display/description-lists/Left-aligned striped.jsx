    ...
    <div>
      ...
      <div className="mt-6 border-t border-white/5">
        <dl className="divide-y divide-white/5">
          <div className="bg-gray-800/25 px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-3">
          ...
          <div className="bg-gray-900 px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-3">
