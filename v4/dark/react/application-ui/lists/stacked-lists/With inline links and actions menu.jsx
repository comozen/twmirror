        ...
        <li key={person.email} className="flex justify-between gap-x-6 py-5">
          ...
          <div className="flex shrink-0 items-center gap-x-6">
            ...
            <Menu as="div" className="relative flex-none">
              ...
              <MenuItems
                transition
                className="absolute right-0 z-10 mt-2 w-32 origin-top-right rounded-md bg-gray-800 py-2 outline -outline-offset-1 outline-white/10 transition data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in"
              >
                <MenuItem>
                  <a
                    href="#"
