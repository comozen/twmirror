          ...
          <div className="flex w-full items-center justify-between space-x-6 p-6">
            <div className="flex-1 truncate">
              <div className="flex items-center space-x-3">
                ...
                <span className="inline-flex shrink-0 items-center rounded-full bg-green-500/10 px-1.5 py-0.5 text-xs font-medium text-green-500 inset-ring inset-ring-green-500/10">
                  {person.role}
                </span>
              </div>
            ...
            <img
              alt=""
              src={person.imageUrl}
              className="size-10 shrink-0 rounded-full bg-gray-700 outline -outline-offset-1 outline-white/10"
            />
          </div>
          <div>
