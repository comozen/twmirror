            ...
            <table className="relative min-w-full divide-y divide-white/15">
              <thead>
                <tr>
                  ...
                  <th scope="col" className="px-2 py-3.5 text-left text-sm font-semibold whitespace-nowrap text-white">
                    Company
                  </th>
                  <th scope="col" className="px-2 py-3.5 text-left text-sm font-semibold whitespace-nowrap text-white">
                    Share
              ...
              <tbody className="divide-y divide-white/10 bg-gray-900">
                {transactions.map((transaction) => (
                  <tr key={transaction.id}>
                    <td className="py-2 pr-3 pl-4 text-sm whitespace-nowrap text-gray-400 sm:pl-0">{transaction.id}</td>
                    <td className="px-2 py-2 text-sm font-medium whitespace-nowrap text-white">
                      {transaction.company}
                    </td>
                    <td className="px-2 py-2 text-sm whitespace-nowrap text-white">{transaction.share}</td>
                    <td className="px-2 py-2 text-sm whitespace-nowrap text-gray-400">{transaction.commission}</td>
                    <td className="px-2 py-2 text-sm whitespace-nowrap text-gray-400">{transaction.price}</td>
                    <td className="px-2 py-2 text-sm whitespace-nowrap text-gray-400">{transaction.quantity}</td>
                    <td className="px-2 py-2 text-sm whitespace-nowrap text-gray-400">{transaction.netAmount}</td>
