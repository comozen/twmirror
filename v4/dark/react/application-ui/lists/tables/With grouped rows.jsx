          ...
          <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
            <table className="relative min-w-full">
              <thead className="bg-gray-900">
                <tr>
                  <th scope="col" className="py-3.5 pr-3 pl-4 text-left text-sm font-semibold text-white sm:pl-3">
                    Name
                  </th>
                  ...
                  <Fragment key={location.name}>
                    <tr className="border-t border-white/10">
                      <th
                        scope="colgroup"
                        colSpan={5}
                        className="bg-gray-800/50 py-2 pr-3 pl-4 text-left text-sm font-semibold text-white sm:pl-3"
                      >
                        {location.name}
                      </th>
                    </tr>
                    {location.people.map((person, personIdx) => (
                      <tr
                        key={person.email}
                        className={classNames(personIdx === 0 ? 'border-white/15' : 'border-white/10', 'border-t')}
                      >
