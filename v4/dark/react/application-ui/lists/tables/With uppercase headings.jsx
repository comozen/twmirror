            ...
            <table className="relative min-w-full divide-y divide-white/15">
              <thead>
                <tr>
                  <th
                    scope="col"
                    className="py-3 pr-3 pl-4 text-left text-xs font-medium tracking-wide text-gray-400 uppercase sm:pl-0"
                  >
                    Name
                  </th>
                  <th
                    scope="col"
                    className="px-3 py-3 text-left text-xs font-medium tracking-wide text-gray-400 uppercase"
                  >
                    Title
                  </th>
                  <th
