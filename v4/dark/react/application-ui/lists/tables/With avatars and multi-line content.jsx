              ...
              <tbody className="divide-y divide-white/10 bg-gray-900">
                {people.map((person) => (
                  <tr key={person.email}>
                    <td className="py-5 pr-3 pl-4 text-sm whitespace-nowrap sm:pl-0">
                      <div className="flex items-center">
                        <div className="size-11 shrink-0">
                          <img alt="" src={person.image} className="size-11 rounded-full outline outline-white/10" />
                        </div>
                        <div className="ml-4">
                    ...
                    <td className="px-3 py-5 text-sm whitespace-nowrap text-gray-400">{person.role}</td>
