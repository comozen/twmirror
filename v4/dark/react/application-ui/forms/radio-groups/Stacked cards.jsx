      ...
      <div className="space-y-4">
        {plans.map((plan) => (
          <label
            ...
            className="group relative block rounded-lg border border-white/10 bg-gray-800/50 px-6 py-4 has-checked:outline-2 has-checked:-outline-offset-2 has-checked:outline-indigo-500 has-focus-visible:outline-3 has-focus-visible:-outline-offset-1 sm:flex sm:justify-between"
          >
            <input
            ...
            <span className="mt-2 flex text-sm sm:mt-0 sm:ml-4 sm:flex-col sm:text-right">
              ...
              <span className="ml-1 text-gray-400 sm:ml-0">/mo</span>
            </span>
          </label>
        ))}
      </div>
