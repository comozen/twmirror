          ...
          {query.length > 0 && (
            ...
            >
              <div className="flex items-center">
                <div className="grid size-6 shrink-0 place-items-center rounded-full bg-gray-600 in-data-focus:bg-white">
                  <UserIcon className="size-4 fill-white in-data-focus:fill-indigo-500" aria-hidden="true" />
                </div>
            ...
            >
              <div className="flex items-center">
                <img
                  src={person.imageUrl}
                  alt=""
                  className="size-6 shrink-0 rounded-full bg-gray-700 outline -outline-offset-1 outline-white/10"
                />
