      ...
      <div>
        ...
        <div className="lg:pl-72">
          <div className="sticky top-0 z-40 lg:mx-auto lg:max-w-7xl lg:px-8">
            <div className="flex h-16 items-center gap-x-4 border-b border-white/10 bg-gray-900 px-4 sm:gap-x-6 sm:px-6 lg:px-0">
              <button
                type="button"
                    ...
                    >
                      {userNavigation.map((item) => (
                        <MenuItem key={item.name}>
                          <a
                            href={item.href}
                            className="block px-3 py-1 text-sm/6 text-white data-focus:bg-gray-700 data-focus:outline-hidden"
                          >
                            {item.name}
                          </a>
                        </MenuItem>
