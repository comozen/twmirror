              ...
              <div className="p-4">
                <div className="flex items-center">
                  <div className="flex w-0 flex-1 justify-between">
                    ...
                    <button
                      type="button"
                      className="ml-3 shrink-0 rounded-md bg-gray-800 text-sm font-medium text-indigo-400 hover:text-indigo-300 focus:outline-2 focus:outline-offset-2 focus:outline-indigo-400"
                    >
                      Undo
                    </button>
                  </div>
