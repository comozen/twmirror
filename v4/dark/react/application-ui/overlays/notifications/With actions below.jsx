                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 w-0 flex-1 pt-0.5">
                    ...
                    <div className="mt-3 flex space-x-7">
                      <button
                        type="button"
                        className="rounded-md text-sm font-medium text-indigo-400 hover:text-indigo-300 focus:outline-2 focus:outline-offset-2 focus:outline-indigo-400"
                      >
                        Undo
                      </button>
                      <button
                        type="button"
                        className="rounded-md text-sm font-medium text-gray-300 hover:text-white focus:outline-2 focus:outline-offset-2 focus:outline-indigo-400"
                      >
                        Dismiss
                      </button>
                    </div>
