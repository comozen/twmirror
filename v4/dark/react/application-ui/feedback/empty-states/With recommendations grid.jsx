    ...
    <div className="mx-auto max-w-md sm:max-w-3xl">
      <div>
        ...
        <form action="#" className="mt-6 sm:flex sm:items-center">
          <div className="flex grow items-center rounded-md bg-white/5 pl-3 outline-1 -outline-offset-1 outline-white/10 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-indigo-500">
            <input
              name="emails"
              type="text"
          ...
          <div className="mt-3 sm:mt-0 sm:ml-4 sm:shrink-0">
            <button
              type="submit"
              className="block w-full rounded-md bg-indigo-500 px-3 py-2 text-center text-sm font-semibold text-white hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
            >
              Send invite
            </button>
          </div>
        ...
        <ul role="list" className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
          {people.map((person, personIdx) => (
            <li key={personIdx}>
              <button
                type="button"
                className="group flex w-full items-center justify-between space-x-3 rounded-full border border-white/10 p-2 text-left hover:bg-white/5 focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500"
              >
