              ...
              <li key={item.name}>
                ...
                >
                  ...
                  {item.count ? (
                    <span
                      aria-hidden="true"
                      className="ml-auto w-9 min-w-max rounded-full bg-gray-800 px-2.5 py-0.5 text-center text-xs/5 font-medium whitespace-nowrap text-gray-400 outline-1 -outline-offset-1 outline-white/10"
                    >
                      {item.count}
                    </span>
                  ) : null}
