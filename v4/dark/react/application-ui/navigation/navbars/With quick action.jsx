        ...
        <div className="flex h-16 justify-between">
          ...
          <div className="flex items-center">
            <div className="shrink-0">
              <button
                type="button"
                className="relative inline-flex items-center gap-x-1.5 rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
              >
      ...
      <DisclosurePanel className="md:hidden">
        <div className="space-y-1 pt-2 pb-3">
          ...
          <DisclosureButton
            as="a"
            href="#"
            className="block border-l-4 border-indigo-500 bg-indigo-600/10 py-2 pr-4 pl-3 text-base font-medium text-indigo-400 sm:pr-6 sm:pl-5"
          >
            Dashboard
          </DisclosureButton>
          <DisclosureButton
            as="a"
            href="#"
            className="block border-l-4 border-transparent py-2 pr-4 pl-3 text-base font-medium text-gray-300 hover:border-white/20 hover:bg-white/5 hover:text-white sm:pr-6 sm:pl-5"
          >
            Team
          </DisclosureButton>
          <DisclosureButton
