    ...
    <div className="isolate bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto mt-20 max-w-lg space-y-16">
        <div className="flex gap-x-6">
          ...
          <div>
            <h3 className="text-base/7 font-semibold text-white">Sales support</h3>
        ...
        <div className="flex gap-x-6">
          ...
          <div>
            <h3 className="text-base/7 font-semibold text-white">Bug reports</h3>
            <p className="mt-2 text-base/7 text-gray-400">
        ...
        <div className="flex gap-x-6">
          ...
          <div>
            <h3 className="text-base/7 font-semibold text-white">Technical support</h3>
            <p className="mt-2 text-base/7 text-gray-400">
