      ...
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        ...
        <section className="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
          <div className="lg:pr-8">
            <h2 className="text-2xl font-semibold tracking-tight text-pretty text-white">Our mission</h2>
            ...
            <p className="mt-8 text-base/7 text-gray-400">
          ...
          <div className="pt-16 lg:row-span-2 lg:-mr-16 xl:mr-auto">
            <div className="-mx-8 grid grid-cols-2 gap-4 sm:-mx-16 sm:grid-cols-4 lg:mx-0 lg:grid-cols-2 xl:gap-8">
              <div className="aspect-square overflow-hidden rounded-xl outline-1 -outline-offset-1 outline-white/10">
                <img
                  alt=""
              ...
              <div className="-mt-8 aspect-square overflow-hidden rounded-xl outline-1 -outline-offset-1 outline-white/10 lg:-mt-40">
                <img
                  alt=""
