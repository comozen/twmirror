  ...
  return (
    <Popover className="relative isolate z-50 shadow-sm">
      ...
      >
        ...
        <div aria-hidden="true" className="absolute inset-0 top-1/2 bg-gray-900 ring-1 ring-white/10" />
        <div className="relative bg-gray-900">
          <div className="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-6 py-10 lg:grid-cols-2 lg:px-8">
            <div className="grid grid-cols-2 gap-x-6 sm:gap-x-8">
              <div>
                <h3 className="text-sm/6 font-medium text-gray-400">Engagement</h3>
                  ...
                  <div className="-my-2">
                    {engagement.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="flex gap-x-4 py-2 text-sm/6 font-semibold text-white"
                      >
                        <item.icon aria-hidden="true" className="size-6 flex-none text-gray-500" />
                        {item.name}
                      </a>
                    ))}
                  </div>
              ...
              <div>
                <h3 className="text-sm/6 font-medium text-gray-400">Resources</h3>
                <div className="mt-6 flow-root">
                  <div className="-my-2">
                    {resources.map((item) => (
                      <a
                ...
                >
                  <div className="relative flex-none">
                    <img
                      alt=""
                      src={post.imageUrl}
                      className="aspect-2/1 w-full rounded-lg bg-gray-800 object-cover sm:aspect-video sm:h-32 lg:h-auto"
                    />
                  ...
                  <div>
                    <div className="flex items-center gap-x-4">
                      ...
                      <a
                        ...
                        className="relative z-10 rounded-full bg-gray-800 px-3 py-1.5 text-xs font-medium text-gray-400 hover:bg-gray-700"
                      >
                        {post.category.title}
                      </a>
                    </div>
                    <h4 className="mt-2 text-sm/6 font-semibold text-white">
                      <a href={post.href}>
                        <span className="absolute inset-0" />
                        {post.title}
                      </a>
                    </h4>
                    <p className="mt-2 text-sm/6 text-gray-400">{post.description}</p>
                  </div>
                </article>
              ))}
            </div>
