<template>
  <div class="bg-white dark:bg-gray-900">
    <main class="mx-auto w-full max-w-7xl px-6 pt-10 pb-16 sm:pb-24 lg:px-8">
      <img class="mx-auto h-10 w-auto sm:h-12 dark:hidden" src="/plus-assets/img/logos/mark.svg?color=indigo&shade=600" alt="Your Company" />
      <img class="mx-auto h-10 w-auto not-dark:hidden sm:h-12" src="/plus-assets/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company" />
      <div class="mx-auto mt-20 max-w-2xl text-center sm:mt-24">
        ...
        <h1 class="mt-4 text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-6xl dark:text-white">This page does not exist</h1>
      ...
      <div class="mx-auto mt-16 flow-root max-w-lg sm:mt-20">
        ...
        <ul role="list" class="-mt-6 divide-y divide-gray-900/5 border-b border-gray-900/5 dark:divide-white/10 dark:border-white/10">
          <li v-for="(link, linkIdx) in links" :key="linkIdx" class="relative flex gap-x-6 py-6">
            <div class="flex size-10 flex-none items-center justify-center rounded-lg shadow-xs outline-1 outline-gray-900/10 dark:bg-gray-800/50 dark:-outline-offset-1 dark:outline-white/10">
