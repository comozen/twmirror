      ...
      <div class="mx-auto mt-24 max-w-7xl px-6 sm:mt-56 lg:px-8">
        <div class="mx-auto grid max-w-2xl grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div class="flex flex-col pb-10 sm:pb-16 lg:pr-8 lg:pb-0 xl:pr-20">
            <img class="h-12 self-start dark:hidden" src="/plus-assets/img/logos/tuple-logo-gray-900.svg" alt="" />
            <img class="h-12 self-start not-dark:hidden" src="/plus-assets/img/logos/tuple-logo-white.svg" alt="" />
          ...
          <div class="flex flex-col border-t border-gray-900/10 pt-10 sm:pt-16 lg:border-t-0 lg:border-l lg:pt-0 lg:pl-8 xl:pl-20 dark:border-white/10">
            <img class="h-12 self-start dark:hidden" src="/plus-assets/img/logos/reform-logo-gray-900.svg" alt="" />
            <img class="h-12 self-start not-dark:hidden" src="/plus-assets/img/logos/reform-logo-white.svg" alt="" />
            <figure class="mt-10 flex flex-auto flex-col justify-between">
              <blockquote class="text-lg/8 text-gray-900 dark:text-gray-100">
