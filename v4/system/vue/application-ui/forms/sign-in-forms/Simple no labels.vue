<template>
  ...
  <div class="flex min-h-full flex-1 items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
    <div class="w-full max-w-sm space-y-10">
      <div>
        <img class="mx-auto h-10 w-auto dark:hidden" src="/plus-assets/img/logos/mark.svg?color=indigo&shade=600" alt="Your Company" />
        <img class="mx-auto h-10 w-auto not-dark:hidden" src="/plus-assets/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company" />
