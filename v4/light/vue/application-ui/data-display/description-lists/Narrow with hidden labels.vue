    ...
    <div class="rounded-lg bg-gray-50 shadow-xs outline-1 outline-gray-900/5">
      <dl class="flex flex-wrap">
        ...
        <div class="flex-none self-end px-6 pt-4">
          ...
          <dd class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 inset-ring inset-ring-green-600/20">Paid</dd>
        </div>
      ...
      <div class="mt-6 border-t border-gray-900/5 px-6 py-6">
        <a href="#" class="text-sm/6 font-semibold text-gray-900 hover:text-gray-700">Download receipt <span aria-hidden="true">&rarr;</span></a>
      </div>
    </div>
  </div>
</template>
