<template>
  ...
  <main>
    <div class="relative isolate overflow-hidden pt-16">
      ...
      <div class="absolute top-full left-0 -z-10 mt-96 origin-top-left translate-y-40 -rotate-90 transform-gpu opacity-20 blur-3xl sm:left-1/2 sm:-mt-10 sm:-ml-96 sm:translate-y-0 sm:rotate-0 sm:opacity-50" aria-hidden="true">
