      ...
      <table class="min-w-full divide-y divide-gray-300">
        ...
        <tbody class="divide-y divide-gray-200 bg-white">
          <tr v-for="person in people" :key="person.email">
            ...
            <td class="hidden px-3 py-4 text-sm whitespace-nowrap text-gray-500 sm:table-cell">{{ person.title }}</td>
            <td class="hidden px-3 py-4 text-sm whitespace-nowrap text-gray-500 lg:table-cell">{{ person.email }}</td>
