      ...
      <div class="flex flex-col border-b border-gray-200 lg:border-0">
        ...
        <div class="relative">
          ...
          <div class="h-48 w-full sm:h-64 lg:absolute lg:top-0 lg:right-0 lg:h-full lg:w-1/2">
            <img src="/plus-assets/img/ecommerce-images/home-page-02-hero-half-width.jpg" alt="" class="size-full object-cover" />
          </div>
        </div>
      </div>
      ...
      <div class="relative overflow-hidden">
        ...
        <div aria-hidden="true" class="absolute inset-0">
          <div class="absolute inset-0 mx-auto max-w-7xl overflow-hidden xl:px-8">
            <img src="/plus-assets/img/ecommerce-images/home-page-02-sale-full-width.jpg" alt="" class="size-full object-cover" />
          </div>
          ...
          <div class="lg:grid lg:grid-cols-2 lg:gap-x-6 xl:gap-x-8">
            ...
            <div class="relative mt-6 flex items-center px-6 py-12 sm:px-10 sm:py-16 lg:mt-0">
              <div class="absolute inset-0 overflow-hidden rounded-lg">
                <img src="/plus-assets/img/ecommerce-images/footer-02-exclusive-sale.jpg" alt="" class="size-full object-cover saturate-0 filter" />
          ...
          <div class="mt-4 flex items-center justify-center md:mt-0">
            ...
            <div class="ml-6 border-l border-gray-200 pl-6">
              <a href="#" class="flex items-center text-gray-500 hover:text-gray-600">
                <img src="/plus-assets/img/flags/flag-canada.svg" alt="" class="h-auto w-5 shrink-0" />
...
const trendingProducts = [
  {
    ...
    price: '$35',
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-02-product-01.jpg',
  ...
  },
  {
    ...
    price: '$28',
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-02-product-02.jpg',
  ...
  },
  {
    ...
    price: '$50',
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-02-product-03.jpg',
  ...
  },
  {
    ...
    price: '$50',
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-02-product-04.jpg',
...
const collections = [
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-02-edition-01.jpg',
  ...
  },
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-02-edition-02.jpg',
  ...
  },
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-02-edition-03.jpg',
