          ...
          <div class="mt-6 -mb-6 flow-root divide-y divide-gray-200 border-t border-gray-200">
            <div v-for="product in order.products" :key="product.id" class="py-6 sm:flex">
              ...
              <div class="mt-6 space-y-4 sm:mt-0 sm:ml-6 sm:w-40 sm:flex-none">
                <button type="button" class="flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-2.5 py-2 text-sm font-medium text-white shadow-xs hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden sm:grow-0">Buy again</button>
                <button type="button" class="flex w-full items-center justify-center rounded-md border border-gray-300 bg-white px-2.5 py-2 text-sm font-medium text-gray-700 shadow-xs hover:bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden sm:grow-0">Shop similar</button>
              </div>
            </div>
          </div>
        </section>
    ...
    products: [
      {
        ...
        color: 'Brass',
        size: '3" x 3" x 3"',
        imageSrc: '/plus-assets/img/ecommerce-images/order-history-page-07-product-01.jpg',
      ...
      },
      {
        ...
        color: 'Natural',
        size: 'Large',
        imageSrc: '/plus-assets/img/ecommerce-images/order-history-page-07-product-02.jpg',
      ...
      },
      {
        ...
        color: 'Olive',
        size: '4" L x 2.75" W',
        imageSrc: '/plus-assets/img/ecommerce-images/order-history-page-07-product-03.jpg',
    ...
    products: [
      {
        ...
        imageSrc: '/plus-assets/img/ecommerce-images/order-history-page-07-product-04.jpg',
