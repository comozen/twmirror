                ...
                <div class="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                  ...
                  <div class="mt-4 sm:mt-0 sm:pr-9">
                    <div class="inline-grid w-full max-w-16 grid-cols-1">
                      <select :id="`quantity-${productIdx}`" :name="`quantity-${productIdx}`" :aria-label="`Quantity, ${product.name}`" class="col-start-1 row-start-1 appearance-none rounded-md bg-white py-1.5 pr-8 pl-3 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
...
const relatedProducts = [
  {
    ...
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/shopping-cart-page-01-related-product-01.jpg',
  ...
  },
  {
    ...
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/shopping-cart-page-01-related-product-02.jpg',
  ...
  },
  {
    ...
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/shopping-cart-page-01-related-product-03.jpg',
  ...
  },
  {
    ...
    name: 'Organize Set',
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/shopping-cart-page-01-related-product-04.jpg',
