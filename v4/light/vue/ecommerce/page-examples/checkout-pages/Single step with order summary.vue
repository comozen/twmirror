            ...
            <div class="mt-10 border-t border-gray-200 pt-10">
              ...
              <fieldset aria-label="Delivery method" class="mt-4">
                <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                  <label v-for="deliveryMethod in deliveryMethods" :key="deliveryMethod.id" :aria-label="deliveryMethod.title" :aria-description="`${deliveryMethod.turnaround} for ${deliveryMethod.price}`" class="group relative flex rounded-lg border border-gray-300 bg-white p-4 has-checked:outline-2 has-checked:-outline-offset-2 has-checked:outline-indigo-600 has-focus-visible:outline-3 has-focus-visible:-outline-offset-1 has-disabled:border-gray-400 has-disabled:bg-gray-200 has-disabled:opacity-25">
                    <input type="radio" name="delivery-method" :value="deliveryMethod.id" :checked="deliveryMethod === deliveryMethods[0]" class="absolute inset-0 appearance-none focus:outline-none" />
                    <div class="flex-1">
...
const products = [
  {
    ...
    color: 'Black',
    size: 'Large',
    imageSrc: '/plus-assets/img/ecommerce-images/checkout-page-02-product-01.jpg',
  ...
  },
  {
    ...
    color: 'Sienna',
    size: 'Large',
    imageSrc: '/plus-assets/img/ecommerce-images/checkout-page-02-product-02.jpg',
