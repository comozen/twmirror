    ...
    <header class="relative mx-auto max-w-7xl bg-indigo-900 py-6 lg:grid lg:grid-cols-2 lg:gap-x-16 lg:bg-transparent lg:px-8 lg:pt-16 lg:pb-10">
      <div class="mx-auto flex max-w-2xl px-4 lg:w-full lg:max-w-lg lg:px-0">
        <a href="#">
          ...
          <img src="/plus-assets/img/logos/mark.svg?color=indigo&amp;shade=300" alt="" class="h-8 w-auto lg:hidden" />
          <img src="/plus-assets/img/logos/mark.svg?color=indigo&amp;shade=600" alt="" class="hidden h-8 w-auto lg:block" />
        </a>
      </div>
    </header>
        ...
        <form>
          <div class="mx-auto max-w-2xl px-4 lg:max-w-none lg:px-0">
            ...
            <div class="mt-10 flex justify-end border-t border-gray-200 pt-6">
              <button type="submit" class="rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-xs hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50 focus:outline-hidden">Pay now</button>
            </div>
          </div>
        </form>
      </section>
...
const products = [
  {
    ...
    size: '15L',
    imageSrc: '/plus-assets/img/ecommerce-images/checkout-page-07-product-01.jpg',
  ...
  },
  {
    ...
    color: 'Sand',
    size: '11L',
    imageSrc: '/plus-assets/img/ecommerce-images/checkout-page-07-product-02.jpg',
  ...
  },
  {
    ...
    color: 'Light gray',
    size: '0.3L',
    imageSrc: '/plus-assets/img/ecommerce-images/checkout-page-07-product-03.jpg',
