        ...
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                    ...
                    <PopoverPanel class="absolute right-0 z-10 mt-2 origin-top-right rounded-md bg-white p-4 shadow-2xl ring-1 ring-black/5 focus:outline-hidden">
                      <form class="space-y-4">
                        <div v-for="(option, optionIdx) in section.options" :key="option.value" class="flex gap-3">
                          <div class="flex h-5 shrink-0 items-center">
                            <div class="group grid size-4 grid-cols-1">
                              <input :id="`filter-${section.id}-${optionIdx}`" :name="`${section.id}[]`" :value="option.value" :checked="option.checked" type="checkbox" class="col-start-1 row-start-1 appearance-none rounded-sm border border-gray-300 bg-white checked:border-indigo-600 checked:bg-indigo-600 indeterminate:border-indigo-600 indeterminate:bg-indigo-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:border-gray-300 disabled:bg-gray-100 disabled:checked:bg-gray-100 forced-colors:appearance-auto" />
                              <svg class="pointer-events-none col-start-1 row-start-1 size-3.5 self-center justify-self-center stroke-white group-has-disabled:stroke-gray-950/25" viewBox="0 0 14 14" fill="none">
                                <path class="opacity-0 group-has-checked:opacity-100" d="M3 8L6 11L11 3.5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path class="opacity-0 group-has-indeterminate:opacity-100" d="M3 7H11" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                              </svg>
          ...
          <section aria-labelledby="featured-heading" class="relative mt-16 overflow-hidden rounded-lg lg:h-96">
            <div class="absolute inset-0">
              <img src="/plus-assets/img/ecommerce-images/category-page-01-featured-collection.jpg" alt="" class="size-full object-cover" />
            </div>
            ...
            <div class="absolute inset-x-0 bottom-0 rounded-br-lg rounded-bl-lg bg-black/75 p-6 backdrop-blur-sm backdrop-filter sm:flex sm:items-center sm:justify-between lg:inset-x-auto lg:inset-y-0 lg:w-96 lg:flex-col lg:items-start lg:rounded-tl-lg lg:rounded-br-none">
              ...
              <a href="#" class="mt-6 flex shrink-0 items-center justify-center rounded-md border border-white/25 px-4 py-3 text-base font-medium text-white hover:bg-white/10 sm:mt-0 sm:ml-8 lg:ml-0 lg:w-full">View the collection</a>
            </div>
          </section>
  ...
  categories: [
    {
      ...
      featured: [
        ...
        },
        {
          name: 'Carry',
          href: '#',
          imageSrc: '/plus-assets/img/ecommerce-images/mega-menu-category-04.jpg',
      ...
      featured: [
        {
          name: 'New Arrivals',
          href: '#',
          imageSrc: '/plus-assets/img/ecommerce-images/mega-menu-01-men-category-01.jpg',
          imageAlt: 'Hats and sweaters on wood shelves next to various colors of t-shirts on hangers.',
        },
        {
          name: 'Basic Tees',
          href: '#',
          imageSrc: '/plus-assets/img/ecommerce-images/mega-menu-01-men-category-02.jpg',
          imageAlt: 'Model wearing light heather gray t-shirt.',
        },
        {
          name: 'Accessories',
          href: '#',
          imageSrc: '/plus-assets/img/ecommerce-images/mega-menu-01-men-category-03.jpg',
          imageAlt:
        ...
        },
        {
          name: 'Carry',
          href: '#',
          imageSrc: '/plus-assets/img/ecommerce-images/mega-menu-01-men-category-04.jpg',
...
const products1 = [
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-01-image-card-01.jpg',
  ...
  },
  {
    ...
    price: '$64',
    description: 'Walnut',
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-01-image-card-02.jpg',
  ...
  },
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-01-image-card-03.jpg',
  ...
  },
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-01-image-card-04.jpg',
  ...
  },
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-01-image-card-05.jpg',
  ...
  },
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-01-image-card-06.jpg',
...
const products2 = [
  {
    ...
    price: '$149',
    description: 'Black',
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-01-image-card-07.jpg',
  ...
  },
  {
    ...
    price: '$165',
    description: 'Black',
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-01-image-card-08.jpg',
    imageAlt:
  ...
  },
  {
    ...
    price: '$118',
    description: 'Natural',
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-01-image-card-09.jpg',
    imageAlt:
  ...
  },
  {
    ...
    price: '$95',
    description: 'Includes brass stand',
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-01-image-card-10.jpg',
    imageAlt:
  ...
  },
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-01-image-card-11.jpg',
    imageAlt:
  ...
  },
  {
    ...
    price: '$18',
    description: 'Natural',
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-01-image-card-12.jpg',
