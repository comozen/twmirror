          ...
          <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:col-span-3 lg:gap-x-8">
              <a v-for="product in products" :key="product.id" :href="product.href" class="group text-sm">
                ...
                <p class="text-gray-500 italic">{{ product.availability }}</p>
...
const products = [
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-07-product-01.jpg',
  ...
  },
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-07-product-02.jpg',
  ...
  },
  {
    ...
    price: '$220',
    availability: 'Blue',
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-07-product-03.jpg',
    imageAlt:
  ...
  },
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-07-product-04.jpg',
  ...
  },
  {
    ...
    price: '$140',
    availability: 'White and black',
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-07-product-05.jpg',
  ...
  },
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-07-product-06.jpg',
  ...
  },
  {
    ...
    price: '$90',
    availability: 'Salmon',
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-07-product-07.jpg',
  ...
  },
  {
    ...
    price: '$210',
    availability: 'Clay',
    imageSrc: '/plus-assets/img/ecommerce-images/category-page-07-product-08.jpg',
