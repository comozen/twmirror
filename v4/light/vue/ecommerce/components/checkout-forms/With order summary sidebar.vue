...
const products = [
  {
    ...
    color: 'Birch',
    size: 'L',
    imageSrc: '/plus-assets/img/ecommerce-images/checkout-form-04-product-01.jpg',
  ...
  },
  {
    ...
    color: 'Sienna',
    size: 'M',
    imageSrc: '/plus-assets/img/ecommerce-images/checkout-form-04-product-02.jpg',
  ...
  },
  {
    ...
    color: 'Black',
    size: 'L',
    imageSrc: '/plus-assets/img/ecommerce-images/checkout-form-04-product-03.jpg',
