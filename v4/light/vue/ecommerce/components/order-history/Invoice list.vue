          ...
          <div v-for="order in orders" :key="order.number">
            ...
            <div class="bg-gray-50 px-4 py-6 sm:rounded-lg sm:p-6 md:flex md:items-center md:justify-between md:space-x-6 lg:space-x-8">
              ...
              <div class="mt-6 space-y-4 sm:flex sm:space-y-0 sm:space-x-4 md:mt-0">
                <a :href="order.href" class="flex w-full items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-xs hover:bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden md:w-auto">
                  View Order
                  <span class="sr-only">{{ order.number }}</span>
                </a>
                <a :href="order.invoiceHref" class="flex w-full items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-xs hover:bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-hidden md:w-auto">
                  View Invoice
    ...
    products: [
      {
        ...
        date: 'January 5, 2021',
        datetime: '2021-01-05',
        imageSrc: '/plus-assets/img/ecommerce-images/order-history-page-06-product-01.jpg',
      ...
      },
      {
        ...
        datetime: '2021-01-25',
        imageSrc: '/plus-assets/img/ecommerce-images/order-history-page-06-product-02.jpg',
        imageAlt:
      ...
      },
      {
        ...
        date: 'January 25, 2021',
        datetime: '2021-01-25',
        imageSrc: '/plus-assets/img/ecommerce-images/order-history-page-06-product-03.jpg',
        imageAlt:
    ...
    products: [
      {
        ...
        date: 'January 7, 2021',
        datetime: '2021-01-07',
        imageSrc: '/plus-assets/img/ecommerce-images/order-history-page-06-product-04.jpg',
