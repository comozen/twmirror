  ...
  <div class="bg-white">
    <main>
      ...
      <div class="relative isolate overflow-hidden bg-white">
        ...
        <div class="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:px-8 lg:py-40">
          <div class="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-8">
            <img class="h-11" src="/plus-assets/img/logos/mark.svg?color=indigo&amp;shade=600" alt="Your Company" />
      ...
      <div class="mx-auto mt-8 max-w-7xl px-6 sm:mt-16 lg:px-8">
        <h2 class="text-center text-lg/8 font-semibold text-gray-900">The world’s most innovative companies use our app</h2>
      ...
      <div class="mt-32 sm:mt-56">
        ...
        <div class="relative overflow-hidden pt-16">
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <img src="/plus-assets/img/component-images/project-app-screenshot.png" alt="App screenshot" class="mb-[-12%] rounded-xl shadow-2xl ring-1 ring-gray-900/10" width="2432" height="1442" />
      ...
      <div class="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
        <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
          ...
          <p class="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl">Trusted by thousands of creators&nbsp;worldwide</p>
        ...
        <dl class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-10 text-gray-900 sm:mt-20 sm:grid-cols-2 sm:gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-4">
          <div v-for="stat in stats" :key="stat.id" class="flex flex-col gap-y-3 border-l border-gray-900/15 pl-6">
    ...
    <footer class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="border-t border-gray-200 py-12 md:flex md:items-center md:justify-between">
