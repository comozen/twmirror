<template>
  <div class="bg-white">
    ...
    <main>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div class="text-center">
              ...
              <p class="mt-8 text-lg font-medium text-pretty text-gray-600 sm:text-xl/8">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat.</p>
      ...
      <div class="relative isolate mt-32 px-6 sm:mt-56 lg:px-8">
        ...
        <div class="mx-auto max-w-4xl text-center">
          ...
          <p class="mt-2 text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">Choose the right plan for you</p>
        </div>
        <p class="mx-auto mt-6 max-w-2xl text-center text-lg/8 text-pretty text-gray-600">Choose an affordable plan that’s packed with the best features for engaging your audience, creating customer loyalty, and driving sales.</p>
    ...
    <footer class="mt-32 sm:mt-56">
      <div class="mx-auto max-w-7xl border-t border-gray-200 px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
