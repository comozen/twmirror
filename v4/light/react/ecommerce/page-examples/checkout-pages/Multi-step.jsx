...
const products = [
  {
    ...
    color: 'Gray',
    size: 'S',
    imageSrc: '/plus-assets/img/ecommerce-images/checkout-page-05-product-01.jpg',
  ...
  },
  {
    ...
    color: 'Peach',
    size: 'S',
    imageSrc: '/plus-assets/img/ecommerce-images/checkout-page-05-product-02.jpg',
    imageAlt:
  ...
  },
  {
    ...
    color: 'Forest',
    size: 'L',
    imageSrc: '/plus-assets/img/ecommerce-images/checkout-page-05-product-03.jpg',
