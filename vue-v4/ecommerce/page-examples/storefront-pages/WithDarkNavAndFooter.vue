  ...
  <div class="bg-white">
    ...
    <div class="relative bg-gray-900">
      ...
      <div aria-hidden="true" class="absolute inset-0 overflow-hidden">
        <img src="/plus-assets/img/ecommerce-images/home-page-01-hero-full-width.jpg" alt="" class="size-full object-cover" />
      </div>
                ...
                <div class="flex h-16 items-center justify-between">
                  ...
                  <div class="hidden lg:flex lg:flex-1 lg:items-center">
                    <a href="#">
                      ...
                      <img class="h-8 w-auto" src="/plus-assets/img/logos/mark.svg?color=white" alt="" />
                    </a>
                  </div>
                  ...
                  <a href="#" class="lg:hidden">
                    <span class="sr-only">Your Company</span>
                    <img src="/plus-assets/img/logos/mark.svg?color=white" alt="" class="h-8 w-auto" />
                  </a>
    ...
    <main>
      ...
      <section aria-labelledby="social-impact-heading" class="mx-auto max-w-7xl px-4 pt-24 sm:px-6 sm:pt-32 lg:px-8">
        <div class="relative overflow-hidden rounded-lg">
          <div class="absolute inset-0">
            <img src="/plus-assets/img/ecommerce-images/home-page-01-feature-section-01.jpg" alt="" class="size-full object-cover" />
          </div>
      ...
      <section aria-labelledby="comfort-heading" class="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
        <div class="relative overflow-hidden rounded-lg">
          <div class="absolute inset-0">
            <img src="/plus-assets/img/ecommerce-images/home-page-01-feature-section-02.jpg" alt="" class="size-full object-cover" />
          </div>
          <div class="relative bg-gray-900/75 px-6 py-32 sm:px-12 sm:py-40 lg:px-16">
            <div class="relative mx-auto flex max-w-3xl flex-col items-center text-center">
...
const categories = [
  {
    name: 'New Arrivals',
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-01-category-01.jpg',
  },
  {
    name: 'Productivity',
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-01-category-02.jpg',
  },
  {
    name: 'Workspace',
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-01-category-04.jpg',
  },
  {
    name: 'Accessories',
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-01-category-05.jpg',
  },
  {
    name: 'Sale',
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-01-category-03.jpg',
  },
]
const collections = [
  {
    ...
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-01-collection-01.jpg',
  ...
  },
  {
    ...
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-01-collection-02.jpg',
  ...
  },
  {
    ...
    href: '#',
    imageSrc: '/plus-assets/img/ecommerce-images/home-page-01-collection-03.jpg',
