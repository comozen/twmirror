      ...
      <div class="mx-auto max-w-2xl px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8">
        ...
        <section aria-labelledby="details-heading">
          ...
          <div class="mt-16 grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-8">
            <div>
              <img src="/plus-assets/img/ecommerce-images/product-page-04-detail-product-shot-01.jpg" alt="Drawstring top with elastic loop closure and textured interior padding." class="aspect-3/2 w-full rounded-lg object-cover" />
            ...
            <div>
              <img src="/plus-assets/img/ecommerce-images/product-page-04-detail-product-shot-02.jpg" alt="Front zipper pouch with included key ring." class="aspect-3/2 w-full rounded-lg object-cover" />
...
const policies = [
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce/icons/icon-delivery-light.svg',
  },
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce/icons/icon-chat-light.svg',
  },
  {
    ...
    imageSrc: '/plus-assets/img/ecommerce/icons/icon-fast-checkout-light.svg',
  },
  {
    name: 'Gift Cards',
    description:
    ...
    imageSrc: '/plus-assets/img/ecommerce/icons/icon-gift-card-light.svg',
  },
]
const reviews = {
  average: 4,
