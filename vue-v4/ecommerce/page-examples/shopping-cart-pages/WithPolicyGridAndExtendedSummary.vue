          ...
          <div class="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 lg:gap-x-8 lg:gap-y-0">
            <div v-for="policy in policies" :key="policy.name" class="text-center md:flex md:items-start md:text-left lg:block lg:text-center">
              <div class="md:shrink-0">
                <div class="flow-root">
                  <img class="mx-auto -my-1 h-24 w-auto" :src="policy.imageSrc" alt="" />
                </div>
              </div>
...
const policies = [
  {
    name: 'Free returns',
    imageSrc: '/plus-assets/img/ecommerce/icons/icon-returns-light.svg',
    description: 'Not what you expected? Place it back in the parcel and attach the pre-paid postage stamp.',
  },
  {
    name: 'Same day delivery',
    imageSrc: '/plus-assets/img/ecommerce/icons/icon-calendar-light.svg',
    description:
  ...
  {
    name: 'For the planet',
    imageSrc: '/plus-assets/img/ecommerce/icons/icon-planet-light.svg',
