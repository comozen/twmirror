    ...
    <div class="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
      ...
      <div class="mt-10 border-t border-gray-200">
        ...
        <div v-for="product in products" :key="product.id" class="flex space-x-6 border-b border-gray-200 py-10">
          <img :src="product.imageSrc" :alt="product.imageAlt" class="size-20 flex-none rounded-lg bg-gray-100 object-cover sm:size-40" />
...
const products = [
  {
    ...
    quantity: 1,
    price: '$32.00',
    imageSrc: '/plus-assets/img/ecommerce-images/confirmation-page-05-product-01.jpg',
