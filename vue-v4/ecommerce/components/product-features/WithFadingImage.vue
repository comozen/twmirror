<template>
  <div class="bg-white">
    <div aria-hidden="true" class="relative">
      <img src="/plus-assets/img/ecommerce-images/product-feature-02-full-width.jpg" alt="" class="h-96 w-full object-cover" />
      <div class="absolute inset-0 bg-linear-to-t from-white" />
    </div>
