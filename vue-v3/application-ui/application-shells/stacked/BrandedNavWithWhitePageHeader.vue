      ...
      <DisclosurePanel class="md:hidden">
        ...
        <div class="border-t border-indigo-700 pb-3 pt-4">
          <div class="flex items-center px-5">
            ...
            <button type="button" class="relative ml-auto shrink-0 rounded-full border-2 border-transparent bg-indigo-600 p-1 text-indigo-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600">
              <span class="absolute -inset-1.5" />
              <span class="sr-only">View notifications</span>
              <BellIcon class="size-6" aria-hidden="true" />
            </button>
