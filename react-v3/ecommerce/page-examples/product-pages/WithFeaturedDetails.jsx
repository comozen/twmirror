            ...
            <div className="mt-16 grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-8">
              <div>
                <img
                  ...
                  src="/plus-assets/img/ecommerce-images/product-page-04-detail-product-shot-01.jpg"
              ...
              <div>
                <img
                  ...
                  src="/plus-assets/img/ecommerce-images/product-page-04-detail-product-shot-02.jpg"
                  className="aspect-[3/2] w-full rounded-lg object-cover"
                />
                <p className="mt-8 text-base text-gray-500">
