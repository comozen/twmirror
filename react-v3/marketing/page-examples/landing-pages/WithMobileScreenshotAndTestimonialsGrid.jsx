      ...
      <main>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-12 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 sm:gap-y-14 lg:mx-0 lg:max-w-none lg:grid-cols-5">
            <img
              alt="Transistor"
              src="/plus-assets/img/logos/158x48/transistor-logo-gray-400.svg"
              width={158}
              height={48}
            ...
            <img
              alt="Reform"
              src="/plus-assets/img/logos/158x48/reform-logo-gray-400.svg"
              width={158}
              height={48}
              className="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
            />
            <img
              alt="Tuple"
              src="/plus-assets/img/logos/158x48/tuple-logo-gray-400.svg"
              width={158}
              height={48}
              className="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
            />
            <img
              alt="SavvyCal"
              src="/plus-assets/img/logos/158x48/savvycal-logo-gray-400.svg"
              width={158}
              height={48}
            ...
            <img
              alt="Statamic"
              src="/plus-assets/img/logos/158x48/statamic-logo-gray-400.svg"
              width={158}
              height={48}
